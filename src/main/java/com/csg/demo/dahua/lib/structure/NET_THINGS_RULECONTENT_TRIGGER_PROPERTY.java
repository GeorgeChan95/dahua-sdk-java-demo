...
public class NET_THINGS_RULECONTENT_TRIGGER_PROPERTY extends NetSDKLib.SdkStructure {
    ...
    /**
     * 对比值类型 {@link com.csg.demo.dahua.lib.enumeration.EM_PROPERTIES_VALUE_TYPE}
     */
    public int              emCompareValueType;
    /**
     * 设备列表个数
    */
    public int              nDeviceListNum;
    /**
     * 设备列表
    */
    public BYTE_ARRAY_4[]   szDeviceList = new BYTE_ARRAY_4[64];
    /**
     * 报警信息列表个数
    */
     ...
     * 报警信息列表
    */
    public BYTE_ARRAY_32[]  szPropertyList = new BYTE_ARRAY_32[64];
    /**
     * 保留字节
     */
    public byte[]           szReserve = new byte[252];
}
