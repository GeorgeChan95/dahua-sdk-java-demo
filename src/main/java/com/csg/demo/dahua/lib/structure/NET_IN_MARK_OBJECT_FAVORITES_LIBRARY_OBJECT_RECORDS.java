...
public class NET_IN_MARK_OBJECT_FAVORITES_LIBRARY_OBJECT_RECORDS extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 收藏的目标事件数据, 内存由用户申请释放, 大小为sizeof(NET_OBJECT_FAVORITES_LIBRARY_COLLECT_DATA)*nCollectDatasNum,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_OBJECT_FAVORITES_LIBRARY_COLLECT_DATA}
    */
