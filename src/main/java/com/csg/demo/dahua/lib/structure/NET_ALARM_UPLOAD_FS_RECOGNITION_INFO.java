...
public class NET_ALARM_UPLOAD_FS_RECOGNITION_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              nEventID;
    /**
     * 目标数据,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_ALARM_UPLOAD_FS_DATA}
    */
    public NET_ALARM_UPLOAD_FS_DATA stuFaceData = new NET_ALARM_UPLOAD_FS_DATA();
    /**
     * 检测到的物体,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_MSG_OBJECT_EX2}
    */
    public NetSDKLib.NET_MSG_OBJECT_EX2 stuObject = new NetSDKLib.NET_MSG_OBJECT_EX2();
    /**
     * 当前目标匹配到的候选对象信息,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.CANDIDATE_INFO}
    */
    ...
    */
    ...
    /**
     * 全景图片信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_RECOGNITION_PIC_INFO}
    */
