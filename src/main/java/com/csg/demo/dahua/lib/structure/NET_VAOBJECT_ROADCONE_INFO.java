...
{
    /**
     * 包围盒, 路锥对象在全景图中的框坐标,为0~8191相对坐标,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_RECT_EX}
    */
    public NET_RECT_EX      stuBoundingBox = new NET_RECT_EX();
    /**
     * 包围盒, 绝对坐标,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_RECT_EX}
    */
    public NET_RECT_EX      stuOriginalBoundingBox = new NET_RECT_EX();
    /**
     * 物体型心（不是包围盒中心）,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_POINT_EX}
    */
    ...
    */
    ...
    /**
     * 物体动作支持类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_VAOBJECT_ROADCONE_ACTION}
    */
    public int              emAction;
    /**
     * 预留字节
