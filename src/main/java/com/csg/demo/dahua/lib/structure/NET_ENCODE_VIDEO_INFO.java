...
import com.csg.demo.dahua.lib.enumeration.NET_EM_FORMAT_TYPE;
import com.csg.demo.dahua.lib.enumeration.NET_EM_IMAGE_QUALITY;
import com.csg.demo.dahua.lib.enumeration.NET_EM_VIDEO_COMPRESSION;
...
public class NET_ENCODE_VIDEO_INFO extends NetSDKLib.SdkStructure {
    ...
    /**
     * 图像组，即I帧间隔 1-150，比如50表示每49个B帧或P帧，设置一个I帧。0表示自动调整I帧间隔
    */
    public int              nAiGOP;
