...
import static com.csg.demo.dahua.lib.NetSDKLib.CFG_COMMON_STRING_32;
import static com.csg.demo.dahua.lib.constant.SDKStructureFieldLenth.MAX_PROTOCOL_NAME_LEN;
...
public class CFG_PTZ_PROTOCOL_CAPS_INFO extends NetSDKLib.SdkStructure {
    ...
    /**
     * 支持的支持的焦距模式掩码,从低位到高位依次数,见{@link com.csg.demo.dahua.lib.enumeration.EM_SUPPORT_FOCUS_MODE}
     */
    ...
    /**
     * 风扇能力,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_PTZ_FAN_CAPS}
    */
    public CFG_PTZ_FAN_CAPS stuPtzFan = new CFG_PTZ_FAN_CAPS();
    /**
     * 视窗加热器能力,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_WINDOW_HEATER_CAPS}
    */
    public CFG_WINDOW_HEATER_CAPS stuWindowHeater = new CFG_WINDOW_HEATER_CAPS();
    /**
     * 加热器能力,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_PTZ_HEATER}
    */
    public CFG_PTZ_HEATER   stuPtzHeater = new CFG_PTZ_HEATER();
    /**
     * 云台一键锁定,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_PTZ_ONE_CLICK_LOCK}
    */
