...
public class NET_VIDEOIN_COLOR_INFO extends NetSDKLib.SdkStructure
{
    public int              dwSize;
    /**
     * 配置类型，获取和设置时都要指定,参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_EM_CONFIG_TYPE}
    */
    ...
    */
    public int              nGamma;
    /**
     * 色彩风格,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_COLOR_STYLE_TYPE}
    */
    ...
    */
    ...
    /**
     * 对应的时间段,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TSECT}
    */
