...
public class NET_CFG_DOOR_STATE_DETECTION_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 报警联动,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_ALARM_MSG_HANDLE}
    */
    ...
    */
    public int              nLink;
    /**
     * 联动业务大类选项,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_LINK_CLASS_TYPE}
    */
    ...
    */
    ...
    /**
     * 辅助线（两点),参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_POINT_EX}
    */
    ...
    */
    ...
    /**
     * 门状态的报警指定时间段，在指定时间段开门或关门为异常，产生报警,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_CFG_TIME_SCHEDULE}
    */
    public NetSDKLib.NET_CFG_TIME_SCHEDULE stuDSTimeSection = new NetSDKLib.NET_CFG_TIME_SCHEDULE();
    /**
     * 开门状态的报警指定时间段，在指定时间段开门达到LongTime，产生报警,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_CFG_TIME_SCHEDULE}
    */
