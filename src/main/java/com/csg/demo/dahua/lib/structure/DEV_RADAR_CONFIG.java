...
public class DEV_RADAR_CONFIG extends NetSDKLib.SdkStructure {
    ...
    */
    ...
    /**
     * 川速雷达配置,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_TRANS_RADAR_CONFIG}
    */
    public NET_TRANS_RADAR_CONFIG stuTransRadarConfig = new NET_TRANS_RADAR_CONFIG();
    /**
     * 纳雷雷达配置,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_NALEI_RADAR_CONFIG}
    */
    ...
    */
    ...
    /**
     * 速度修正,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_RADAR_SPEED_MODIFY}
    */
    ...
    */
    ...
    /**
     * 雷达速度修正配置,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_RADAR_SPEED_CORRECTION}
    */
