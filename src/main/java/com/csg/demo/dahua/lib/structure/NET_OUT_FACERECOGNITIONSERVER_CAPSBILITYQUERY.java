...
public class NET_OUT_FACERECOGNITIONSERVER_CAPSBILITYQUERY extends NetSDKLib.SdkStructure {
	...
	/**
	 * 是否支持以图搜图 {@link com.csg.demo.dahua.lib.enumeration.EM_SUPPORT_SEARCH_BY_PIC}
	 */
     ...
     * 支持的电梯控制方式类型的集合个数
    */
    public int              nSupportLiftControlTypesCount;
    /**
     * 支持的电梯控制方式类型的集合,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_FACE_RECOGNITION_SUPPORT_LIFT_CONTROL_TYPES}
    */
    public int[]            emSupportLiftControlTypes = new int[8];
    /**
     * 是否支持人脸1V1 相似度比对
    */
    public int              bSupportMatchTwoFace;
    /**
     * 带特征值抠图支持的目标类型掩码，填0代表都不支持
    */
    public int              nSupportDetectObjectTypeMask;
    /**
     * 是否支持图片质量检测
    */
    public int              bSupportQualityDetect;
