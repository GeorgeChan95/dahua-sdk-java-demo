...
public class NET_OUT_LIGHTINGCONTROL_CAPS extends NetSDKLib.SdkStructure {
    ...
    public int              bSupport;
    /**
     * /支持的灯光配置版本 {@link com.csg.demo.dahua.lib.enumeration.EM_LC_CONFIG_VERSION}
     */
    public int              emConfigVersion;
    /**
     * /灯光类型 {@link com.csg.demo.dahua.lib.enumeration.EM_LC_LIGHT_TYPE}
     */
    ...
    /**
     * /默认支持的模式 {@link com.csg.demo.dahua.lib.enumeration.EM_LC_MODE}
     */
    ...
    /**
     * 防补光过曝,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_ANTIFILLLIGHTOVEREXPOSURE}
    */
    public NET_ANTIFILLLIGHTOVEREXPOSURE stuAntiFillLightOverExposure = new NET_ANTIFILLLIGHTOVEREXPOSURE();
    /**
     * 亮度上限调节,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_BRIGHTNESSUPPERLIMIT}
    */
    public NET_BRIGHTNESSUPPERLIMIT stuBrightnessUpperLimit = new NET_BRIGHTNESSUPPERLIMIT();
