...
public class NET_ALARM_USER extends NetSDKLib.SdkStructure {
	...
	/**
	 * 用户状态 {@link com.csg.demo.dahua.lib.enumeration.EM_GETUSERINFOBYCONDITION_USER_STATUS}
	 */
	...
	/**
	 * 用户的权限列表，数组值参考{@link com.csg.demo.dahua.lib.enumeration.EM_ALARM_USERAUTHORITY}
	 */
    public int[]            emAuthorityList = new int[32];
	/**
	 * 用户所在组 {@link com.csg.demo.dahua.lib.enumeration.EM_ALARM_USER_GROUP}
	 */
    public int              emGroup;
	/**
	 * 是否为保留用户，保留用户不可删除
	...
	/**
	 * 用户类型 {@link com.csg.demo.dahua.lib.enumeration.EM_GETUSERINFOBYCONDITION_USER_TYPE}
	 */
