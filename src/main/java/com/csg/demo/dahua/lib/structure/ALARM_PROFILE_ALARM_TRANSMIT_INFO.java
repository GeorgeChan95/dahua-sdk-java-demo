...
public class ALARM_PROFILE_ALARM_TRANSMIT_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              nAction;
    /**
     * 事件发生时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    public NetSDKLib.NET_TIME stuTime = new NetSDKLib.NET_TIME();
    /**
     * 传感器类型,参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_SENSE_METHOD}
    */
    ...
    */
    ...
    /**
     * 报警源设备的类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_ALARM_TRANSMIT_DEV_SRC_TYPE}
    */
    public int              emDevSrcType;
    /**
     * 报警类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_ALARM_TRANSMIT_ALARM_TYPE}
    */
    ...
    */
    ...
    /**
     * 报警附带信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_PROFILE_ALARM_INFO}
    */
