...
public class CFG_WRITE_ON_THE_BOARD_DETECTION_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 警戒区， 多边形类型，多边形中每个端点的坐标归一化到[0,8192)区间。,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.CFG_POLYLINE}
    */
    ...
    */
    ...
    /**
     * 系统联动特写模式, 为UNKNOWN时不下发,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_CLOSE_UP_MODE}
    */
    ...
    */
    ...
    /**
     * 联动码流类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_LINKAGE_STREAM_TYPE}
    */
    ...
    */
    ...
    /**
     * 检测区,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.CFG_POLYGON}
    */
