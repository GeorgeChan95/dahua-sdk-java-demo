...
public class NET_OUT_SECURITY_GET_TASK_STATUS_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              dwSize;
    /**
     * 当前任务类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_SECURITY_TASK_TYPE}
    */
    public int              nTaskType;
    /**
     * 当前任务状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_SECURITY_TASK_STATUS}
    */
    public int              nStatus;
    /**
