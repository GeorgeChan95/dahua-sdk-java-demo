...
public class SCENE_SUPPORT_RULE extends NetSDKLib.SdkStructure {
    ...
    /**
     * 工装检测规则能力集,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_WORK_CLOTHES_DETECTION_CAPS}
    */
    public CFG_WORK_CLOTHES_DETECTION_CAPS stuWorkClothesDetectionCaps = new CFG_WORK_CLOTHES_DETECTION_CAPS();
    /**
     * 保留字节
    */
