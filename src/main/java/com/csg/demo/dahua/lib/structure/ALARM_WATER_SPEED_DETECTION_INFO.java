...
public class ALARM_WATER_SPEED_DETECTION_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 事件的数据类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.NETAEM_EVENT_TYPE}
    */
    ...
    */
    ...
    /**
     * 水流速度信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_WATER_SPEED_INFO}
    */
    ...
    */
    ...
    /**
     * 水流速状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_WATER_SPEED_STATUS}
    */
    public int              emStatus;
    /**
     * 原始图，近景,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_INTELLIGENCE_IMAGE_INFO}
    */
    public NetSDKLib.NET_INTELLIGENCE_IMAGE_INFO stuOriginalImage = new NetSDKLib.NET_INTELLIGENCE_IMAGE_INFO();
    /**
     * 球机变到最小倍下的抓图,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_INTELLIGENCE_IMAGE_INFO}
    */
