...
{
    /**
     * 设备位置坐标, 取值均为0-8191,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_UINT_RECT}
    */
    public NET_UINT_RECT    stuRect = new NET_UINT_RECT();
    /**
     * 物体截图,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_SMART_MOTION_EQUIPMENT_OBJECT_IMAGE_INFO}
    */
    public NET_SMART_MOTION_EQUIPMENT_OBJECT_IMAGE_INFO stuImage = new NET_SMART_MOTION_EQUIPMENT_OBJECT_IMAGE_INFO();
    /**
     * 设备运行状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_SMART_MOTION_EQUIPMENT_MOTION_STATUS}
    */
