...
public class DEV_EVENT_HEAT_IMAGING_TEMPER_INFO extends NetSDKLib.SdkStructure {
	 ...
	 * {@link com.csg.demo.dahua.lib.enumeration.NET_RADIOMETRY_RESULT}
	 */
    public int              emResult;
	/**
	 * 报警条件 {@link com.csg.demo.dahua.lib.enumeration.NET_RADIOMETRY_ALARMCONTION}
	 */
	...
	/**
	 * 温度单位(当前配置的温度单位) {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TEMPERATURE_UNIT }
	 */
    ...
    */
     ...
     * 字节对齐
    */
    public byte[]           szResvered2 = new byte[4];
    /**
     * 报警产生时间，本地时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME_EX}
    */
    public NetSDKLib.NET_TIME_EX stuTime = new NetSDKLib.NET_TIME_EX();
    public byte[]           reserved = new byte[708];
