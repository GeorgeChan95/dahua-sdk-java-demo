...
public class CFG_CAP_SCENE extends NetSDKLib.SdkStructure {
    ...
    */
    ...
    /**
     * 车辆密度,由用户申请，内存大小为sizeof(CFG_VEHICLES_DISTRI),参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_VEHICLES_DISTRI}
    */
    public Pointer          pstuVehiclesDistri;
    /**
     * 人群分布图,由用户申请，内存大小为sizeof(CFG_CROWD_DISTRI_MAP),参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_CROWD_DISTRI_MAP}
    */
    public Pointer          pstuCrowdDistriMap;
    /**
     * 结构化支持人脸美颜具体参数,由用户申请，内存大小为sizeof(CFG_FACE_BEAUTIFICATION_CAPS),bFaceBeautificationCaps为TRUE时有效,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_FACE_BEAUTIFICATION_CAPS}
    */
    public Pointer          pstuFaceBeautificationCaps;
    /**
     * 是否允许配置人脸美化 FALSE-不支持 TRUE-支持
    */
    public int              bFaceBeautificationCaps;
    /**
     *  保留字节
     */
    public byte[]           byReserved = new byte[1020-3*NetSDKLib.POINTERSIZE];
