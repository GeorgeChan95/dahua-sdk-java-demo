...
public class CFG_NUMBERSTAT_INFO extends NetSDKLib.SdkStructure {
	 ...
	 * {@link com.csg.demo.dahua.lib.enumeration.CFG_LINK_TYPE}
	 */
    public int              emType;
	/**
    ...
    /**
     * 人数去重策略配置,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_DUPLICATE_REMOVE_INFO}
    */
    public CFG_DUPLICATE_REMOVE_INFO stuDuplicateRemove = new CFG_DUPLICATE_REMOVE_INFO();
    /**
     * 保留字段
    */
