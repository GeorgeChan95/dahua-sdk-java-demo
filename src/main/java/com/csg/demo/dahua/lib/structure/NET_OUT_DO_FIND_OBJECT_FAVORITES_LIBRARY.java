...
public class NET_OUT_DO_FIND_OBJECT_FAVORITES_LIBRARY extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 查询到的记录集合, 内存由用户申请释放, 大小为sizeof(NET_OBJECT_FAVORITES_LIBRARY_RECORDS)*nMaxCount,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_OBJECT_FAVORITES_LIBRARY_RECORDS}
    */
