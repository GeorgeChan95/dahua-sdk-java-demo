...
public class NET_DEV_EVENT_QUANTIFY_TREND_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 均值波动次数超限报警信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_VOLATILITY_ALARM_INFO}
    */
    public NET_VOLATILITY_ALARM_INFO stuVolatilityAlarm = new NET_VOLATILITY_ALARM_INFO();
    /**
     * 均值斜率超限报警信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_SLOPE_ALARM_INFO}
    */
