...
public class NET_GET_UPNPSTATUS_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              bWorking;
    /**
     * 状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_UPNP_STATUS_TYPE}
    */
    public int              emStatus;
    /**
     * 内部IP
    ...
    */
    ...
    /**
     * 端口映射状态信息指针，由调用者分配内存,分配的大小为 nMaxPortMapStatus*sizeof(EM_PORTMAP_STATUS_TYPE),参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_PORTMAP_STATUS_TYPE}
    */
