...
public class NET_CLUSTER_DETAIL_CONDITION extends NetSDKLib.SdkStructure {
    ...
    */
    public int              bRealUTC;
    /**
     * 查询起始时间, 标准UTC时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    public NetSDKLib.NET_TIME stuStartRealUTC = new NetSDKLib.NET_TIME();
    /**
     * 查询结束时间, 标准UTC时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    ...
    */
    public int              bUTC;
    /**
     * 查询起始时间, 带时区偏差的UTC时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    public NetSDKLib.NET_TIME stuStartUTC = new NetSDKLib.NET_TIME();
    /**
     * 查询结束时间, 带时区偏差的UTC时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
