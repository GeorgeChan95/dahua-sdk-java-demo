...
public class NET_CFG_PARKING_SPACE_LIGHT_CONTROL_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 指示灯控制配置数组指针，由用户申请释放，大小为sizeof(NET_PARKING_SPACE_LIGHT_CONTROL)*nParkingSpaceLightControlNum,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_PARKING_SPACE_LIGHT_CONTROL}
    */
