...
public class NET_CFG_MOTION_DETECT_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 动态检测联动,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_ALARM_MSG_HANDLE}
    */
    ...
    */
    ...
    /**
     * 三代动检支持的视频窗口,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_MOTION_DETECT_WINDOW}
    */
