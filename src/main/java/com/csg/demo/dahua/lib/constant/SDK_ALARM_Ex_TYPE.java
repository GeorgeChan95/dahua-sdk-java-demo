package com.csg.demo.dahua.lib.constant;

import com.csg.demo.dahua.lib.structure.ALARM_SOLARCELL_SYSTEM_INFO;
...
public class SDK_ALARM_Ex_TYPE {
    /**
     * 太阳能系统信息上报(对应结构体 {@link ALARM_SOLARCELL_SYSTEM_INFO}),枚举值对应的回调接口{@link com.csg.demo.dahua.lib.NetSDKLib.fMessCallBack#invoke(int, NetSDKLib.LLong, Pointer, int, String, NativeLong, Pointer)}
    ...
    /**
     * 无硬盘报警,对应结构体{@link com.csg.demo.dahua.lib.structure.ALARM_NO_DISK_INFO}
     * 对应的回调接口{@link NetSDKLib.fMessCallBack#invoke(int, NetSDKLib.LLong, Pointer, int, String, NativeLong, Pointer)}
     * 对应的接口{@link NetSDKLib#CLIENT_StartListenEx(NetSDKLib.LLong)}
     */
