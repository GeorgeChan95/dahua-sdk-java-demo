...
public class CFG_WLAN_INFO extends NetSDKLib.SdkStructure {
	...
	* WPA3-SAE				AES(CCMP)					"WPA3-SAE-CCMP"						
	...
	/**
	 * 认证方式, 暂时没用 {@link com.csg.demo.dahua.lib.enumeration.EM_CFG_WIRELESS_AUTHENTICATION}
	 */
    public int              emAuthentication;
	/**
	 * 数据加密方式, 暂时没用 {@link com.csg.demo.dahua.lib.enumeration.EM_CFG_WIRELESS_DATA_ENCRYPT}
	 */
