...
{
    /**
     * 温度异常报警相关配置,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_CFG_TEMPERATURE_ABNORMAL_INFO}
    */
    public NET_CFG_TEMPERATURE_ABNORMAL_INFO stuTemperatureAbnormal = new NET_CFG_TEMPERATURE_ABNORMAL_INFO();
    /**
     * 超速报警相关配置,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_CFG_OVER_SPEED_INFO}
    */
    public NET_CFG_OVER_SPEED_INFO stuOverSpeed = new NET_CFG_OVER_SPEED_INFO();
    /**
     * 晃动检测相关配置,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_CFG_SWAY_ABNORMAL_INFO}
    */
