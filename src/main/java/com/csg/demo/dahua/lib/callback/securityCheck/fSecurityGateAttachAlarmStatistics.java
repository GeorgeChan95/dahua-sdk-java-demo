package com.csg.demo.dahua.lib.callback.securityCheck;
...
public interface fSecurityGateAttachAlarmStatistics extends Callback{
     ...
     * @param pInfo 安全门报警统计信息，对应结构体{@link com.csg.demo.dahua.lib.structure.NET_SECURITYGATE_ALARM_STATISTICS_INFO}
     * @param dwUser 用户数据
     */
    void invoke(
