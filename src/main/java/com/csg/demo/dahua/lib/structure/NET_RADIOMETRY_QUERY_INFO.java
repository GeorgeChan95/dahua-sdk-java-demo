...
{
    /**
     * 记录时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    ...
    */
    public int              nRuleId;
    /**
     * 查询类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_RADIOMETRY_QUERY_TYPE}
    */
    ...
    */
    ...
    /**
     * 查询测温点坐标,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_POINT}
    */
    ...
    */
    public int              nChannel;
    /**
     * 温度单位,参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TEMPERATURE_UNIT}
    */
    public int              emTemperatureUnit;
    /**
     * 温度信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_QUERY_TEMPER_INFO}
    */
