...
{
    /**
     * X射线源最小电流值组，元素表示各个视角最小电流值,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_XRAY_SOURCE_CURRENT_ARRAY}
    */
    public NET_XRAY_SOURCE_CURRENT_ARRAY stuMinCurrent = new NET_XRAY_SOURCE_CURRENT_ARRAY();
    /**
     * X射线源最大电流值组，元素表示各个视角最大电流值,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_XRAY_SOURCE_CURRENT_ARRAY}
    */
