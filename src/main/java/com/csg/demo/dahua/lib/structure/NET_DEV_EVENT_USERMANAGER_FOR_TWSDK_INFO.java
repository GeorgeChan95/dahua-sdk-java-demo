 ...
 */
public class NET_DEV_EVENT_USERMANAGER_FOR_TWSDK_INFO extends NetSDKLib.SdkStructure
{
	/**
	 * 通道号
	 */
     ...
     * 用户ID扩展
    */
    public byte[]           szUserIDEx = new byte[40];
	/**
	 * 预留字节
	 */
    public byte[]           szReserved = new byte[532];
