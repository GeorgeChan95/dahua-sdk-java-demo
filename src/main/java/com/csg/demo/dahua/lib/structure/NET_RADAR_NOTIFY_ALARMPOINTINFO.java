...
public class NET_RADAR_NOTIFY_ALARMPOINTINFO extends NetSDKLib.SdkStructure {
    ...
    /**
     * 雷达设备识别到目标上报的时间，时间是标准UTC时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    ...
    */
    ...
    /**
     * 雷达报警点信息扩展，指针由SDK内部申请释放,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_RADAR_ALARMPOINT_INFO}
    */
