...
public class NET_CFG_ACCESS_DISPLAY_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              dwSize;
    /**
     * 主页配置选项,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_HOME_PAGE}
    */
    ...
    */
    ...
    /**
     * 广告分屏模式设备广告显示配置,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_ADVERTISE_DISPLAY}
    */
    public NET_ADVERTISE_DISPLAY stuAdvertiseDisplay = new NET_ADVERTISE_DISPLAY();
    /**
     * 广告分屏模式列表，最大32个,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_ADVERTISE_SPLITLIST}
    */
