...
public class ALARM_CITY_MOTORPARKING_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 检测区域,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_POINT}
    */
    ...
    */
    ...
    /**
     * 云台信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.PTZ_NORMALIZED_POSITION_UNIT}
    */
    public PTZ_NORMALIZED_POSITION_UNIT stuPtzPosition = new PTZ_NORMALIZED_POSITION_UNIT();
    /**
     * 车辆状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_CITYMOTOR_STATUS}
    */
