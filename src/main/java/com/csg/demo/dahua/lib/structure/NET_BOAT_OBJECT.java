...
public class NET_BOAT_OBJECT extends NetSDKLib.SdkStructure {
    ...
    public int              nSpeed;
	/**
	 * 物体动作支持类型 {@link com.csg.demo.dahua.lib.enumeration.EM_ACTION}
	 */
	...
	/**
	 * 行驶方向 {@link com.csg.demo.dahua.lib.enumeration.EM_BOAT_DIRECTION}
	 */
    ...
    */
    ...
    /**
     * 载货状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_BOAT_CARGO_TYPE}
    */
