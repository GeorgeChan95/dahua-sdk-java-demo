...
import static com.csg.demo.dahua.lib.constant.SDKStructureFieldLenth.MAX_ADDRESS_LEN;
import static com.csg.demo.dahua.lib.constant.SDKStructureFieldLenth.MAX_PASSWORD_LEN;
...
public class CFG_ACCESS_GENERAL_INFO extends NetSDKLib.SdkStructure {
  ...
  /** 门禁通道单双向配置,对应枚举{@link com.csg.demo.dahua.lib.enumeration.CFG_ACCESS_PROPERTY_TYPE} */
   ...
   */
    ...
    */
    ...
    /**
     * AB互锁信息扩展,由用户申请内存,大小为sizeof(CFG_ABLOCK_INFO_EX),参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_ABLOCK_INFO_EX}
    */
