...
public class NET_IN_START_FIND_OBJECT_MEDIA_FIND extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              dwSize;
    /**
     * 收藏的开始时间点,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    public NetSDKLib.NET_TIME stuStartTimeRealUTC = new NetSDKLib.NET_TIME();
    /**
     * 收藏的结束时间点,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    ...
    */
    ...
    /**
     * 目标轨迹过滤规则,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_OBJECT_TRACK_FILTER}
    */
