...
public class CFG_HUMANTRAIT_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 支持的目标检测类型列表,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_VIDEO_ANALYSE_HUMANFACE_TYPE}
    */
    ...
    */
    ...
    /**
     * 规则特定的尺寸过滤器，提高判断精度,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.CFG_SIZEFILTER_INFO}
    */
    ...
    */
    ...
    /**
     * 需检测的目标属性,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_FACEFEATURE_TYPE}
    */
    public int[]            emFaceFeatureType = new int[32];
    /**
     * 前端事件响应时间段,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_TIME_SECTION}
    */
    public CFG_TIME_SECTION_ARRAY_6[] stuRemoteTimeSection = new CFG_TIME_SECTION_ARRAY_6[8];
    /**
     * 保留字节
    */
