...
public class NET_MONITORWALL_SCENE extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 电视墙配置,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_MONITORWALL}
    */
    public NetSDKLib.NET_MONITORWALL stuMonitorWall = new NetSDKLib.NET_MONITORWALL();
    /**
     * 拼接屏场景信息数组, 用户分配内存,大小为sizeof(DH_SPLIT_SCENE)*nMaxSplitSceneCount,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_SPLIT_SCENE}
    */
