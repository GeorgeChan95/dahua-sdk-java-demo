...
public class DEV_EVENT_TUMBLE_DETECTION_INFO extends NetSDKLib.SdkStructure {
     ...
     * 人体图片序号
    */
    public int              nIndexInDataInHumanImage;
    /**
     * 人脸图片序号
    */
    public int              nIndexInDataInFaceImage;
    /**
     * 人脸全景图片序号
    */
    public int              nIndexInDataInFaceSceneImage;
    /**
     * 人体属性信息,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.HUMAN_ATTRIBUTES_INFO}
    */
    public Pointer          pstuHumanAttributes;
    /**
     * 人体属性信息扩展,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.HUMAN_ATTRIBUTES_INFO_EX}
    */
    public Pointer          pstuHumanAttributesEx;
    /**
     * 人脸属性,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_FACE_ATTRIBUTE}
    */
