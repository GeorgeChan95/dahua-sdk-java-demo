...
import com.csg.demo.dahua.lib.enumeration.EM_MOBILE_ENFORCE_FILE_TYPE;
import com.csg.demo.dahua.lib.enumeration.EM_MOBILE_ENFORCE_FORMAT;
...
public class MEDIAFILE_MOBILE_ENFORCE_INFO extends NetSDKLib.SdkStructure {
    ...
    */
     ...
     * GPS信息最大个数，最大1800
    */
    public int              nGPSInfosMaxNum;
    /**
     * GPS信息内容，空间由用户提供,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_GPS_STATUS_INFO}
    */
