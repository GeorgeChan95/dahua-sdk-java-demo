...
public class NET_OUT_GET_AREAS_STATUS extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              nAreaRet;
    /**
     * 区域防区异常状态信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_AREA_STATUS}
    */
    ...
    */
    ...
    /**
     * 区域防区异常状态信息扩展，区域个数超过8个使用这个字段,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_AREA_STATUS_EX}
    */
