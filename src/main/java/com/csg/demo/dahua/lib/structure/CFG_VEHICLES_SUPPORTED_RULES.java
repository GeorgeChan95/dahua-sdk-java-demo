...
{
    /**
     * 道路拥堵规则,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_CONGESTION_SUPPORTED_RULES}
    */
    public CFG_CONGESTION_SUPPORTED_RULES stuCongestionDetection = new CFG_CONGESTION_SUPPORTED_RULES();
    /**
     * 停车上限规则,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_VEHICLE_LIMIT_SUPPORTED_RULES}
    */
    public CFG_VEHICLE_LIMIT_SUPPORTED_RULES stuVehicleLimitDetection = new CFG_VEHICLE_LIMIT_SUPPORTED_RULES();
    /**
     * 车辆态势规则,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_VEHICLE_POSTURE_SUPPORTED_RULES}
    */
