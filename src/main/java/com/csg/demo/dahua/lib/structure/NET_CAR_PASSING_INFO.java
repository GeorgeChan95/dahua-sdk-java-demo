...
public class NET_CAR_PASSING_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              nCarSize;
    /**
     * 物体进入还是离开,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_CAR_PASSING_MOVE_STATE}
    */
    public int              emMoveState;
    /**
     * 车辆进出时间，设备本地时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME_EX}
    */
