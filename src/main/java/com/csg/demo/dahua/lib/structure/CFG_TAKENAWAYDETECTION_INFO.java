...
*/
public class CFG_TAKENAWAYDETECTION_INFO extends NetSDKLib.SdkStructure
{
    /**
     * 规则名称,不同规则不能重名
    */
    ...
    */
    ...
    /**
     * 规则特定的尺寸过滤器,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.CFG_SIZEFILTER_INFO}
    */
    ...
    */
    ...
    public CFG_TAKENAWAYDETECTION_INFO() {
