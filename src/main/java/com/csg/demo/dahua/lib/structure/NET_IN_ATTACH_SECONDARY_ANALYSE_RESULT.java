...
public class NET_IN_ATTACH_SECONDARY_ANALYSE_RESULT extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 需要订阅的事件,参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.EM_ANALYSE_EVENT_TYPE}
    */
    ...
    */
    ...
    /**
     * 二次录像分析实时结果订阅函数,参见回调函数定义 {@link com.csg.demo.dahua.lib.NetSDKLib.fAnalyseResultCallBack}
    */
