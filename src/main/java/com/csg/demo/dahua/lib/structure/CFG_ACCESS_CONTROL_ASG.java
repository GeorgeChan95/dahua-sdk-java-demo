...
import com.csg.demo.dahua.lib.enumeration.*;
...
public class CFG_ACCESS_CONTROL_ASG extends NetSDKLib.SdkStructure {
  /** 通行模式,{@link com.csg.demo.dahua.lib.enumeration.EM_PASS_MODE} */
  ...
  /** 二次开启功能开关;False：关闭,True：开启 */
    public int              bSecondOpenEnable;
  /** 记忆功能开关;False：关闭,True：开启 */
    public int              bMemoryModeEnable;
  /** 闸机防冲撞模式,参考枚举{@link EM_COLLISION_MODE} */
    public int              emCollisionMode;
  /** 设备音量等级共8档, 范围:0-7, 0级表示静音 */
    public int              nVolumeLevel;
  /** 闸机断电以后门摆动放向,{@link com.csg.demo.dahua.lib.enumeration.EM_DIRECTION_AFTER_POWER_OFF} */
