...
public class DEV_EVENT_VEHICLELIMIT_DETECTION_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 发生报警的区域坐标,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_POINT}
    */
    public NetSDKLib.NET_POINT[] stuDetectRegion = new NetSDKLib.NET_POINT[32];
    /**
     * 车位类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_SPACE_TYPE}
    */
    ...
    */
    ...
    /**
     * 更新配置信息,每个数组代表一条更新信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_UPDATE_INFO}
    */
