...
public class NET_SPLIT_WINDOW_EX extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 窗口区域, 自由分割模式下有效,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_RECT}
    */
    ...
    */
    public int              nZOrder;
    /**
     * 显示信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_SPLIT_WND_SOURCE}
    */
    ...
    */
    ...
    /**
     * OSD信息指针，用户申请内存,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_SPLIT_OSD}
    */
    public Pointer          pstuOSD;
    /**
     * 水印信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_SPLIT_WATERMARK_INFO}
    */
    public NET_SPLIT_WATERMARK_INFO stuWaterMarkInfo = new NET_SPLIT_WATERMARK_INFO();
