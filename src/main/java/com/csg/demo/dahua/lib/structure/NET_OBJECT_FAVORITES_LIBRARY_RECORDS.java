...
public class NET_OBJECT_FAVORITES_LIBRARY_RECORDS extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              nChannel;
    /**
     * 收藏时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    ...
    */
    ...
    /**
     * 收藏的目标事件数据,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_OBJECT_FAVORITES_LIBRARY_COLLECT_DATA}
    */
