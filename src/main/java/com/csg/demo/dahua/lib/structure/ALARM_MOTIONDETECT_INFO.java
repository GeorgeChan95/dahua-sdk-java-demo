...
public class ALARM_MOTIONDETECT_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 动检区域信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_MOTIONDETECT_REGION_INFO}
    */
    ...
    */
    ...
    /**
     * 动检触发类型, 当nRegionNum大于0时，和stuRegion数组一一对应, , 若nRegionNum为0，触发区域未知，不与窗口绑定，默认第一个元素表示触发类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_MOTION_DETECT_TYPE}
    */
