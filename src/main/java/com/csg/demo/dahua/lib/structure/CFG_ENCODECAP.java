...
import com.csg.demo.dahua.lib.enumeration.CFG_EM_PREVIEW_MODE;

import static com.csg.demo.dahua.lib.constant.SDKStructureFieldLenth.CFG_MAX_PREVIEW_MODE_SPLIT_TYPE_NUM;
import static com.csg.demo.dahua.lib.constant.SDKStructureFieldLenth.CFG_MAX_VIDEO_CHANNEL_NUM;
...
public class CFG_ENCODECAP extends NetSDKLib.SdkStructure {
    ...
    */
     ...
     * 视频浓缩能力元素数量
    */
    public int              nSupportVideoCompressNum;
    /**
     * 参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_SUPPORT_VIDEO_COMPRESS_ENCODECAP}
    */
    public CFG_SUPPORT_VIDEO_COMPRESS_ENCODECAP[] stuSupportVideoCompress = new CFG_SUPPORT_VIDEO_COMPRESS_ENCODECAP[1024];
    /**
     * 保留字节
    */
