...
public class NET_DEV_EVENT_RADARANALYSE_DETECTION_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              nEventID;
    /**
     * 事件发生的本地时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    public NetSDKLib.NET_TIME stuLocaleTime = new NetSDKLib.NET_TIME();
    /**
     * 雷达联动流程的开始时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    public NetSDKLib.NET_TIME stuRadarStartTime = new NetSDKLib.NET_TIME();
    /**
     * 联动信息，保存其他设备传输的信息，比如雷达,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_LINK_INFO}
    */
    public NET_LINK_INFO    stuLinkInfo = new NET_LINK_INFO();
    /**
     * Objects表示多个物体同时触发滞留事件列表，填写检测到的所有物体上限32个数组元素,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_MSG_OBJECT_EX2}
    */
