...
*/
    ...
    /**
     * 穿戴检测结果结果,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_WEAR_DETECT}
    */
    public NET_WEAR_DETECT[] stuWearDetectInfo = new NET_WEAR_DETECT[8];
    /**
     * 穿戴检测结果个数
    */
    public int              nWearDetectNum;
    /**
     * 视频流缺陷检测到的目标信息数量,最大支持10个
    */
    public int              nObjectsNum;
    /**
     * 视频流缺陷检测到的目标信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_ELECTRIC_FAULT_OBJECTS_INFO}
    */
    public Pointer          pstuObjects;
    /**
     * 检测结果扩展信息 内存由SDK内部申请释放,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_EXTEND_DETECT_EX}
    */
    public Pointer          pstuExtendDetectEx;
/** 
预留字段
*/
    public			byte[]         bReserved = new byte[376-2*NetSDKLib.POINTERSIZE];
