...
public class NET_TRAFFIC_FLOW_STATE extends NetSDKLib.SdkStructure {
    ...
    /**
     * 车辆类型流量,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_VEHICLE_TYPE_FLOW}
    */
    public Pointer          pstuVehicleTypeFlow;
    /**
     * 交通流量详细信息，内存由NetSDK申请释放, 部分子字段已于外部实现，后续子字段新增至此,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_TRAFFIC_FLOW_STATE_DETAIL_INFO}
    */
    public Pointer          pstuDetailInfo;
    /**
     * / 保留字节
     */
    public byte[]           reserved = new byte[88-2*NetSDKLib.POINTERSIZE];
