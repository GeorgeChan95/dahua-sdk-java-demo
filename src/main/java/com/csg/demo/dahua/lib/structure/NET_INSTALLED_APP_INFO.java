...
public class NET_INSTALLED_APP_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              nAppID;
    /**
     * APP的调试状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_APP_DEBUG_STATE}
    */
    public int              emAppDebugState;
    /**
     * APP的运行状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_APP_RUNNING_STATE}
    */
    public int              emAppRunningState;
    /**
     * APP的license状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_APP_LICENSE_STATE}
    */
    public int              emAppLicenseState;
    /**
     * APP的能力信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_APP_CAPS}
    */
