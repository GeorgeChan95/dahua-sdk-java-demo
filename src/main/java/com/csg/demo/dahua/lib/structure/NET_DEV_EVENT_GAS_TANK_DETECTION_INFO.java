...
public class NET_DEV_EVENT_GAS_TANK_DETECTION_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              nEventID;
    /**
     * 检测目标的物体信息,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_MSG_OBJECT_EX2}
    */
    public NetSDKLib.NET_MSG_OBJECT_EX2 stuObject = new NetSDKLib.NET_MSG_OBJECT_EX2();
    /**
     * 检测目标的物体信息数组,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_MSG_OBJECT_EX2}
    */
    ...
    */
    public int              nCount;
    /**
     * 事件级别,参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.EM_EVENT_LEVEL}
    */
