...
public class CFG_RIOTER_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 检测区域,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.CFG_POLYGON}
    */
    ...
    */
    ...
    /**
     * 最小聚集区域矩形框，分别对应矩形框的左上和右下点，矩形框的实际面积表示触发报警的最小人群聚集面积,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.CFG_POLYGON}
    */
    ...
    */
    ...
    /**
     * 对应1个或多个排除区域,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_EXCLUDE_REGION_INFO}
    */
    public NET_EXCLUDE_REGION_INFO[] stuExcludeRegions = new NET_EXCLUDE_REGION_INFO[20];
    /**
     * 主动巡视配置信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_PARTOL_LINKAGE_INFO}
    */
