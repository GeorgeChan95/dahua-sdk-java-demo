...
public class MEDIAFILE_HUMAN_TRAIT_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 人体检测信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.HUMAN_TRAIT_INFO}
    */
    public HUMAN_TRAIT_INFO stuHumanTrait = new HUMAN_TRAIT_INFO();
    /**
     * 目标属性信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_HUMAN_FACE_ATTRIBUTE}
    */
    ...
    */
    ...
    /**
     * 人体型心(不是包围盒中心), 0-8191相对坐标, 相对于小图,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_POINT}
    */
