...
public class NET_HISTORY_ACTIVE_CANDIDATE extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 历史库人员信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_HISTORY_PERSON_INFO}
    */
    public NET_HISTORY_PERSON_INFO stuHistoryPerson = new NET_HISTORY_PERSON_INFO();
    /**
     * 查询人员出现的时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    public NetSDKLib.NET_TIME stuTime = new NetSDKLib.NET_TIME();
    /**
     * 目标全景图,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_FACE_IMAGE_INFO}
    */
    ...
    */
    ...
    /**
     * 历史库中人员出现的时间(UTC时间格式),参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    ...
    */
    ...
    /**
     * 目标时间记录,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_HISTORY_CANDIDATE_TIME_RECORD}
    */
    public Pointer          pstuTimeRecord;
    /**
     * 目标时间记录是否有效
    */
     ...
     * 预留字节数
    */
    public byte[]           bReserved = new byte[1048-NetSDKLib.POINTERSIZE];
