...
{
    /**
     * 人群分布图规则,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_CROWD_DISTRI_MAP_RULE}
    */
    public CFG_CROWD_DISTRI_MAP_RULE stuCrowdDistriMap = new CFG_CROWD_DISTRI_MAP_RULE();
    /**
     * 人群态势检测,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_CROWD_POSTURE_DETECTION_RULE}
    */
