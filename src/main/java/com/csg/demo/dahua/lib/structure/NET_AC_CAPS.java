...
/** 
支持安全帽功能 {@link com.csg.demo.dahua.lib.enumeration.EM_SUPPORT_HELMET_TYPE}
*/
...
*/
     ...
     * 是否支持用户单个门绑定多个假日计划
    */
    public int              bSupportDoorMultiSection;
    /**
     * 门禁设备是否支持采集用户信息
    */
    public int              bSupportCollectUserInfo;
    /**
     * 是否支持时间计划数据库方案
    */
    public int              bSupportTimeScheduleDB;
    /**
     * 是否支持出门方式配置（若支持，与进门方式Method可分开配置）
    */
    public int              bSupportOutDoorMethodSetting;
    /**
     * 是否支持掌纹（静脉）目标识别鉴权
    */
    public int              bHasHandPrintAuth;
/** 
保留字节
*/
    public			byte[]         byReserved = new byte[220];
