...
/**
 * 事件类型 EVENT_IVS_UNBROKEN_TRASHBAG(垃圾袋未破袋检测事件)对应的数据块描述信息
*/
public class NET_DEV_EVENT_UNBROKEN_TRASHBAG_INFO extends NetSDKLib.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    ...
    public NET_DEV_EVENT_UNBROKEN_TRASHBAG_INFO() {
