...
import com.csg.demo.dahua.lib.structure.NET_CFG_VSP_GAYS_SERVER_INFO;
import com.sun.jna.Pointer;
import com.sun.jna.ptr.IntByReference;
import com.csg.demo.dahua.lib.structure.NET_CFG_HEALTH_CODE_INFO;
...
public class NET_EM_CFG_OPERATE_TYPE {
    ...
    */
    ...
    /**
     *  状态展示配置, 对应结构体 NET_CFG_STATE_DISPLAY_INFO, 与通道不相关,通道号需要填成-1
    */
    public static final int   NET_EM_CFG_STATE_DISPLAY = 73;
    /**
    ...
    */
    ...
    /**
     *  人员定额消费配置, 对应结构体 NET_CFG_USER_QUOTA_CONSUMPTION_INFO, 与通道不相关，通道号需要填成-1
    */
    public static final int   NET_EM_CFG_USER_QUOTA_CONSUMPTION = 112;
    /*********OSD叠加相关配置*************************************************************************************************/
    ...
    */
    ...
    /**
     *  视频日夜配置切换模式, 对应结构体 NET_CFG_VIDEO_IN_MODE_INFO
    */
    public static final int   NET_EM_CFG_VIDEO_IN_MODE = 1327;
    /***********庭审相关配置*****************************************************************************************/
    public static final int   NET_EM_CFG_ENCODE_PLAN = 1400;        // 刻录光盘编码计划, 对应结构体 NET_ENCODE_PLAN_INFO
    /**
     * 合成通道配置, 对应结构体{@link com.csg.demo.dahua.lib.structure.NET_COMPOSE_CHANNEL_INFO}
     */
    public static final int   NET_EM_CFG_COMPOSE_CHANNEL = 1401;    // 合成通道配置, 对应结构体 NET_COMPOSE_CHANNEL_INFO
    /**
     * 刻录参数, 对应结构体 {@link com.csg.demo.dahua.lib.structure.NET_BURN_PARAM_INFO}
     */
    ...
    */
    ...
    /**
     *  水利雷达相关参数配置, 与通道不相关,通道号需要填成-1, 对应结构体 NET_CFG_WATER_RADAR_INFO
    */
    public static final int   NET_EM_CFG_WATER_RADAR = 2207;
    /**********视频对讲电话通用配置***********************************************************************************/
    ...
    /**
     * 门禁节假日组配置, 对应结构体 {@link com.csg.demo.dahua.lib.structure.NET_CFG_ACCESSCTL_SPECIALDAY_GROUP_INFO}
     */
    ...
    /**
     * 广告禁用时段配置, 对应结构体 {@link com.csg.demo.dahua.lib.structure.NET_CFG_FORBIDDEN_ADVERT_PLAY}, 通道无关，通道号填-1
     */
    public static final int   NET_EM_CFG_FORBIDDEN_ADVERT_PLAY = 3906; // 广告禁用时段配置, 对应结构体 NET_CFG_FORBIDDEN_ADVERT_PLAY, 通道无关，通道号填-1
    /**
     * 门禁设备当前模式配置, 对应结构体 {@link com.csg.demo.dahua.lib.structure.NET_CFG_BGY_CUSTOMERCFG}, 通道无关，通道号填-1
     */
    ...
    */
    ...
    /**
     *  设备界面隐私展示设置配置,对应结构体 NET_CFG_PRIVACY_SET_INFO 通道无关, 通道号填-1
    */
    public static final int   NET_EM_CFG_PRIVACY_SET = 3947;
    /**
     *  访客功能配置, 对应结构体 NET_CFG_VISITOR_INFO, 通道无关, 通道号填-1
    */
    public static final int   NET_EM_CFG_VISITOR = 3948;
    /**
     *  人脸目标识别防假参数配置, 对应结构体 NET_CFG_FACE_ANTIFAKE_STRATEGY_INFO, 通道无关, 通道号填-1
    */
    public static final int   NET_EM_CFG_FACE_ANTIFAKE_STRATEGY = 3962;
    /***********配置************************************************************************************************/
    ...
    */
    ...
    /**
     * 	传送带检测预览OSD 实时数据，对应结构体 NET_CFG_CONVEYORBELT_INFO
    */
    public static final int   NET_EM_CFG_CONVEYORBELTINFO = 4048;
    /**
     * 	GUI界面的配置，对应结构体 NET_CFG_GUISET_INFO
    */
    public static final int   NET_EM_CFG_GUISET = 4049;
    /**
     *  AlertScreen预警显示屏配置,对应结构体 NET_CFG_ALERT_SCREEN_INFO,与通道无关,通道号需要填-1
    */
    public static final int   NET_EM_CFG_ALERT_SCREEN = 4051;
    /**
     *  雷达远程球机联动使能配置, 对应结构体 NET_CFG_RADAR_REMOTESDLINK_INFO
    */
    public static final int   NET_EM_CFG_RADAR_REMOTESDLINK = 6007;
    /***********雷球联动配置************************************************************************************************/
    ...
    */
    ...
    /**
     *  录像计划扩展配置，跟StorageScheduleGlobal配置关联, 对应结构体NET_CFG_COURSE_RECORD_EX
    */
    public static final int   NET_EM_CFG_COURSE_RECORD_EX = 12102;
    /***********硬盘相关配置******************************************************************************************/
