...
public class NET_SLEEPING_CONTROL_TIME_WAKEUP extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              bEnable;
    /**
     * 定时唤醒的方式,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_TIME_WAKEUP_MODE}
    */
    public int              emMode;
    /**
     * 按时间段休眠信息, 仅当Mode为TimeSection时生效,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_TIME_WAKEUP_TIME_SECTION}
    */
