...
public class MEDIAFILE_SMOKE_FIRE_PARAM extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 过滤规则,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_SMOKE_FIRE_FILTER}
    */
    ...
    */
    ...
    /**
     * UTC结束时间(标准UTC时间), 与stuStartTimeRealUTC配对使用，与(stuBeginTime, stuEndTime)互斥,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
