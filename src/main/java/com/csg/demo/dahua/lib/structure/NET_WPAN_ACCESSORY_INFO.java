...
/** 
探测器状态 {@link com.csg.demo.dahua.lib.enumeration.EM_DETECTOR_STATUS_TYPE}
*/
    public			int            emState;
/** 
设备布防时音量 {@link com.csg.demo.dahua.lib.enumeration.EM_ACCESSORY_VOLUME}
*/
    public			int            emBeepVolume;
/** 
灵敏度 {@link com.csg.demo.dahua.lib.enumeration.EM_ACCESSORY_SENSITIVITY}
*/
    public			int            emSensentivity;
/** 
功率调节 {@link com.csg.demo.dahua.lib.enumeration.EM_POWER_REGULATION_TYPE}
*/
    public			int            emPowerRegulation;
/** 
在线状态 {@link com.csg.demo.dahua.lib.enumeration.EM_ONLINE_STATUS}
*/
    public			int            emOnline;
/** 
报警类型 {@link com.csg.demo.dahua.lib.enumeration.EM_ACCESSORY_ALARM_TYPE}
*/
    public			int            emAlarmType;
/** 
输入类型 {@link com.csg.demo.dahua.lib.enumeration.EM_ACCESSORY_INPUT_TYPE}
*/
    public			int            emInputType;
/** 
LED亮度 {@link com.csg.demo.dahua.lib.enumeration.EM_LED_BRIGHTNESS_LEVEL}
*/
    public			int            emLedBrightnessLevel;
/** 
操作模式 {@link com.csg.demo.dahua.lib.enumeration.EM_OPERATION_MODE}
*/
    public			int            emOperationMode;
/** 
防误按模式 {@link com.csg.demo.dahua.lib.enumeration.EM_ANTI_MISPRESS_TYPE}
*/
    public			int            emAntiMispress;
/** 
外部电源状态，若未开启检测外接电源状态则为未知 {@link com.csg.demo.dahua.lib.enumeration.EM_EXPOWER_STATE}
*/
    public			int            emExPowerState;
/** 
设备报警音量 {@link com.csg.demo.dahua.lib.enumeration.EM_ACCESSORY_VOLUME}
*/
    public			int            emVolume;
/** 
环境温度，单位：摄氏度
...
/** 
传感器感应方式 {@link com.csg.demo.dahua.lib.enumeration.EM_BUTTON_ALARM_TYPE}
*/
    public			int            emType;
/** 
心跳信息
...
*/
     ...
     * 配件类型标识
    */
    public byte[]           szDeviceIdentification = new byte[32];
    /**
     * 输出信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_ACCESSORY_OUTPUT_INFO}
    */
    public NET_ACCESSORY_OUTPUT_INFO stuOutput = new NET_ACCESSORY_OUTPUT_INFO();
    /**
     * 外部接入探测器个数
    */
    public int              nExternalSensorCount;
    /**
     * 外部接入探测器信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_ACCESSORY_EXTERNAL_SENSOR_INFO}
    */
    public NET_ACCESSORY_EXTERNAL_SENSOR_INFO[] stuExternalSensor = new NET_ACCESSORY_EXTERNAL_SENSOR_INFO[16];
    /**
     * 移动报警检测,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_ACCESSORY_MOVEMENT_DETECTED_INFO}
    */
    public NET_ACCESSORY_MOVEMENT_DETECTED_INFO stuMovementDetected = new NET_ACCESSORY_MOVEMENT_DETECTED_INFO();
    /**
     * 输入电压，单位V，精确到1个小数点
    */
    public float            fInputVoltage;
    /**
     * 电流，单位A，精确到1个小数点
    */
    ...
    */
     ...
     * 电能，单位KW.h
    */
    public float            fElectricEnergy;
    /**
     * 门铃功能使能是否存在
    */
    public int              abChimeEnable;
    /**
     * 门铃功能使能
    */
    public int              bChimeEnable;
    /**
     * 是否过滤无效字段
    */
    public int              bFilterValidField;
    /**
     * 相机模组信息是否存在
    */
    public int              bCameraInfo;
    /**
     * 相机模组信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_ACCESSORY_CAMERA_INFO}
    */
    public NET_ACCESSORY_CAMERA_INFO stuCameraInfo = new NET_ACCESSORY_CAMERA_INFO();
    /**
     * 随机数，配合抓图测试使用，若携带这个字段，则在设备执行完抓图后，上报的抓图测试事件(ManualTest)中的DelayUploadSeq的值与传入的一致
    */
