 ...
 * 对应枚举类型{@link com.csg.demo.dahua.lib.enumeration.NET_EM_CFG_OPERATE_TYPE#NET_EM_CFG_ACCESSCTL_SPECIALDAYS_SCHEDULE}
 * @date 2020/10/19
 */
public class NET_CFG_ACCESSCTL_SPECIALDAYS_SCHEDULE_INFO extends NetSDKLib.SdkStructure {
    ...
    public int              bSchdule;
    /**
     * {@link com.csg.demo.dahua.lib.enumeration.NET_EM_CFG_OPERATE_TYPE#NET_EM_CFG_ACCESSCTL_SPECIALDAY_GROUP} 配置的下标
     */
    public int              nGroupNo;
    /**
     * 一天的时间段个数
