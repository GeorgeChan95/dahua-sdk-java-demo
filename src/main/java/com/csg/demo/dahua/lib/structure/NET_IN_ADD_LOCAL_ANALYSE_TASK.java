...
public class NET_IN_ADD_LOCAL_ANALYSE_TASK extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 分析规则, 内存由用户申请，大小为size(NET_LOCAL_ANALYSE_TASK_RULE)*nRuleCount,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_LOCAL_ANALYSE_TASK_RULE}
    */
    public Pointer          pstuRule;
    /**
     * 录像开始时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    public NetSDKLib.NET_TIME stuStartTime = new NetSDKLib.NET_TIME();
    /**
     * 录像结束时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
