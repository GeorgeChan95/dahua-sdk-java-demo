 ...
 * 所有传感器的信息
*/
public class NET_IOTBOX_BY_COND_DEVICE_INFO extends NetSDKLib.SdkStructure
{
    /**
     * 传感器通道名称
    */
    ...
    */
    ...
    /**
     * 通道下所有传感器的信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_IOTBOX_BY_COND_CHANNEL_DEVICE_INFO}
    */
    ...
    */
    ...
    public NET_IOTBOX_BY_COND_DEVICE_INFO() {
    }
}
