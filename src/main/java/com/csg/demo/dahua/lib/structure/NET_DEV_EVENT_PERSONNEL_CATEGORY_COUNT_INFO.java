...
public class NET_DEV_EVENT_PERSONNEL_CATEGORY_COUNT_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public double           dbPTS;
    /**
     * 全景广角图,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_PERSONNEL_CATEGORY_SCENE_IMAGE}
    */
    public NET_PERSONNEL_CATEGORY_SCENE_IMAGE stuSceneImage = new NET_PERSONNEL_CATEGORY_SCENE_IMAGE();
    /**
     * 人员信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_PERSONNEL_CATEGORY_PERSON_INFO}
    */
