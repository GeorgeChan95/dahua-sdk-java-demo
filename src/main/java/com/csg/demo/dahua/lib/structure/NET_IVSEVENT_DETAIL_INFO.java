...
{
    /**
     * 报警事件详情,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_IVSEVENT_DATA}
    */
    ...
    */
    ...
    /**
     * 图片信息数组,该接口只有emType、szPath两个字段有效,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_IMAGE_INFO_EX2}
    */
