...
public class MEDIAFILE_IVS_EVENT_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 事件动作,参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_CROSSREGION_ACTION_INFO}
    */
    public int              emAction;
    /**
    ...
    */
    ...
    /**
     * 规则触发的对象类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_MEDIAFILE_IVS_OBJECT}
    */
    public int              emIvsObject;
    /**
     * 事件抠图信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_EVENT_IMAGE_INFO}
    */
    public NET_EVENT_IMAGE_INFO stuEventImageInfo = new NET_EVENT_IMAGE_INFO();
    /**
     * 物体型心(不是包围盒中心), 0-8191相对坐标, 相对于小图,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_POINT}
    */
