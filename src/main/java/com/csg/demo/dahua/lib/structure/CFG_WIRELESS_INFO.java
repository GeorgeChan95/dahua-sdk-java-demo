...
public class CFG_WIRELESS_INFO extends NetSDKLib.SdkStructure {
	...
	/**
	 * 接入的2G网络名称 {@link com.csg.demo.dahua.lib.enumeration.EM_CFG_APN}
	 */
    public int              emAPN;
	/**
	 * 用户名
	...
	/**
	 * 每日流量控制策略 {@link com.csg.demo.dahua.lib.enumeration.EM_CFG_DAY3GFLUXTACTIC}
	 */
	...
	/**
	 * 流量报警策略 {@link com.csg.demo.dahua.lib.enumeration.EM_CFG_DAY3GFLUXACTION}
	 */
	...
	/**
	 * 鉴权模式 {@link com.csg.demo.dahua.lib.enumeration.EM_CFG_AUTHMODE}
	 */
    ...
    public int              n3GFlux;
	/**
	 * 流量使用策略{@link com.csg.demo.dahua.lib.enumeration.EM_CFG_3GFLUXTACTIC}
	 */
	...
	/**
	 * 工作模式选择 {@link com.csg.demo.dahua.lib.enumeration.EM_CFG_WORKMODE}
	 */
