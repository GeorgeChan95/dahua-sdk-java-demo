...
public class NET_XRARY_UNPACKING_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 主视角包裹内危险物品信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_INSIDE_OBJECT}
    */
    ...
    */
    ...
    /**
     * 侧视角包裹内危险物品信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_INSIDE_OBJECT}
    */
    ...
    */
    ...
    /**
     * 开包包裹图片信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_XRAY_UNPACKING_IMAGE_INFO}
    */
    ...
    */
    ...
    /**
     * 主视角包裹内危险物品信息,内存由NetSDK申请释放,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_INSIDE_OBJECT}
    */
    public Pointer          pstuMainViewInside;
    /**
     * 侧视角包裹内危险物品信息,内存由NetSDK申请释放,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_INSIDE_OBJECT}
    */
    ...
    */
    ...
    public byte[]           reserved = new byte[424-NetSDKLib.POINTERSIZE*3];
