...
public class NET_CFG_LIGHTING_LINK_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              bEnable;
    /**
     * 闪烁灯光类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.NET_EM_FILCKERLIGHT_TYPE}
    */
    public int              emFilckerLightType;
    /**
     * 灯光联动方式,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.NET_EM_LIGHTLINK_TYPE}
    */
    ...
    */
    ...
    /**
     * 白光灯联动时间段,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_CFG_TIME_SECTION}
    */
    public NET_CFG_TIME_SECTION_ARRAY_6[] stuWhiteLightTimeSection = new NET_CFG_TIME_SECTION_ARRAY_6[7];
    /**
     * 白光灯时间段内联动使能开关
    */
    public int              bWLTimeSectionEnable;
    /**
     * 白光灯的auto模式
    */
    public int              bEventUpAuto;
    /**
     * 预留字节
    */
