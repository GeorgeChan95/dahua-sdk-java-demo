...
public class NET_OUT_ACCESS_GET_ASG_STATE extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 门翼状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_DOOR_WING_STATE}
    */
    public int              emDoorWingState;
    /**
     * Can通信状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_CAN_COMMUNICATE_STATE}
    */
    ...
    */
    ...
    /**
     * 蓄电池状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_ASG_BATTERY_STATE}
    */
