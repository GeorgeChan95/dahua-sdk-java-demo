...
public class DEV_EVENT_OCR_DETECTION_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 事件发生时间，带时区偏差的UTC时间，单位：秒,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME_EX}
    */
    ...
    */
    ...
    /**
     * 检测类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_OCR_DETECTION_DETECT_TYPE}
    */
    public int              emDetectType;
    /**
     * 检测事件类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_OCR_DETECTION_TRIGGER_TYPE}
    */
    public int              emTriggerType;
    /**
     * 全景广角图，仅IndexInData字段有效,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.SCENE_IMAGE_INFO}
    */
