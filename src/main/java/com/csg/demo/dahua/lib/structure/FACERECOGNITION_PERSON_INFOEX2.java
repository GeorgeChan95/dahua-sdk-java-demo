...
public class FACERECOGNITION_PERSON_INFOEX2 extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 人员预约开始时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    public NetSDKLib.NET_TIME stuAppointmentStartTime = new NetSDKLib.NET_TIME();
    /**
     * 人员预约结束时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    ...
    */
    ...
    /**
     * 平台最近一次修改注册库人员信息的时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    public NetSDKLib.NET_TIME stuModifyTime = new NetSDKLib.NET_TIME();
    /**
     * 注册库入库时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
