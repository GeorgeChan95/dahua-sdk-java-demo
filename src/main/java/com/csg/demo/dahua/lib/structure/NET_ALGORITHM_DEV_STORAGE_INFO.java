...
import com.csg.demo.dahua.lib.enumeration.EM_ALGORITHM_PARTITION_TYPE;
import com.csg.demo.dahua.lib.enumeration.EM_STORAGE_PACKET_TYPE;
...
public class NET_ALGORITHM_DEV_STORAGE_INFO extends NetSDKLib.SdkStructure {
  ...
  /*以上信息当emPakcetType 为EM_STORAGE_PACKET_PARTITION 时有效*/
    /** 预留字节 */ public byte[] byReserved = new byte[1020];
}
