...
import com.csg.demo.dahua.lib.structure.CFG_MOTION_INFO;
...
public enum EM_NEW_CONFIG {
  ...
  /** 语音激励(对应 {@link com.csg.demo.dahua.lib.structure.CFG_AUDIO_SPIRIT}) */
    CFG_CMD_AUDIO_SPIRIT("AudioSpirit"),
  /** 设备安装位置的GPS坐标信息(对应 {@link com.csg.demo.dahua.lib.structure.CFG_DEVLOCATION_INFO}) */
    CFG_CMD_DEVLOCATION("DevLocation"),
  /** 设备参数标定配置(对应 {@link com.csg.demo.dahua.lib.structure.CFG_LOCATION_CALIBRATE_INFO}) */
    CFG_CMD_LOCATION_CALIBRATE("LocationCalibrate"),
  /** 门禁基本配置(对应 {@link com.csg.demo.dahua.lib.structure.CFG_ACCESS_GENERAL_INFO}) */
  ...
  // CFG_ANALYSEGLOBAL_INFO)
    ...
    CFG_CMD_REMOTE_ANALYSERULE("RemoteVideoAnalyseRule"),//远程视频分析规则配置(对应 CFG_ANALYSERULES_INFO)
    CFG_CMD_UPNP("UPnP");//UPnP配置(对应CFG_UPNP_INFO)
