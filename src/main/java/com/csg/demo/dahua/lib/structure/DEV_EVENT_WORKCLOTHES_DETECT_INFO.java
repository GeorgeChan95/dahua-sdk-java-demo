...
public class DEV_EVENT_WORKCLOTHES_DETECT_INFO extends NetSDKLib.SdkStructure {
    ...
    public int              nEventID;
    /**
     * 智能事件所属大类 {@link com.csg.demo.dahua.lib.enumeration.EM_CLASS_TYPE}
     */
    ...
    /**
     * null {@link com.csg.demo.dahua.lib.enumeration.EM_EVENT_WORKCLOTHES_RULE_TYPE}
     */
    ...
    */
     ...
     * 是否上报了Clothes属性
    */
    public byte             bClothes;
    /**
     * 是否上报了WorkPants属性
    */
    public byte             bWorkPants;
    /**
     * 是否上报了NormalHat属性
    */
    public byte             bNormalHat;
    /**
     * 是否上报了Mask属性
    */
    public byte             bMask;
    ...
    */
     ...
     * 是否上报了Prohelmet属性
    */
    public byte             bProhelmet;
    /**
     * 是否上报了Glasses属性
    */
    public byte             bGlasses;
    /**
     * 是否上报了FireProofClothes属性
    */
    public byte             bFireProofClothes;
    /**
     * 是否上报了ProtectiveSuit属性
    */
    public byte             bProtectiveSuit;
    /**
     * 是否上报了Uniform属性
    */
    public byte             bUniform;
    /**
     * 是否上报了BreathingMask属性
    */
    public byte             bBreathingMask;
    /**
     * 是否上报了SafeBelt属性
    */
    public byte             bSafeBelt;
    /**
     * 是否上报了Vest属性
    */
    public byte             bVest;
     ...
     * 是否上报了SafetyShoes属性
    */
    public byte             bSafetyShoes;
    /**
     * 是否上报了WristGuard属性
    */
    public byte             bWristGuard;
    /**
     * 是否上报了SafetyRope属性
    */
    public byte             bSafetyRope;
    /**
     * 是否上报了Armband属性
    */
    public byte             bArmband;
    /**
     * 是否上报了Shoes属性
    */
    public byte             bShoes;
     ...
     * 字节对齐
    */
    public byte[]           szResvered1 = new byte[1];
    /**
     * 预置点ID,如果普通IPC则为0
    */
    ...
    */
    ...
    /**
     * 职员工装,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_EMPLOYEE_CLOTHES_INFO}
    */
    public Pointer          pstuEmployeeClothes;
    /**
     * 二次研判状态,0:未知,1:待研判,2:正报,3:疑似误报,4:漏报
    */
    public int              nSecondEvaluation;
    /**
     * 袖章检测结果,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_ARMBAND_INFO}
    */
    public NET_ARMBAND_INFO stuArmband = new NET_ARMBAND_INFO();
    /**
     * 鞋子检测结果,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_WORK_CLOTHES_SHOES_INFO}
    */
    public NET_WORK_CLOTHES_SHOES_INFO stuShoes = new NET_WORK_CLOTHES_SHOES_INFO();
    /**
     * 发型检测结果,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_HAIR_INFO}
    */
    public NET_HAIR_INFO    stuHair = new NET_HAIR_INFO();
    /**
     * 头套相关属性状态信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_HOOD_INFO}
    */
    public NET_HOOD_INFO    stuHoodInfo = new NET_HOOD_INFO();
    /**
     * 是否上报了Hair属性
    */
    public byte             bHair;
    ...
    */
     ...
     * 预留字节
     */
    public byte[]           byReserved = new byte[86-2*NetSDKLib.POINTERSIZE];
