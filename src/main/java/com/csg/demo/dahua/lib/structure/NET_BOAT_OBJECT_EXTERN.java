...
{
    /**
     * AIS融合目标信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_AIS_FUSE_OBJECT}
    */
    public NET_AIS_FUSE_OBJECT stuAISFuseObject = new NET_AIS_FUSE_OBJECT();
    /**
     * AIS融合目标信息扩展,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_AIS_FUSE_OBJECT_EX}
    */
