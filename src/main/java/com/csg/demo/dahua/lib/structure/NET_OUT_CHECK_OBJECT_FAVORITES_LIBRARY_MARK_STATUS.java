...
public class NET_OUT_CHECK_OBJECT_FAVORITES_LIBRARY_MARK_STATUS extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 收藏结果状态列表, 内存由用户申请释放, 大小为sizeof(NET_OBJECT_FAVORITES_LIBRARY_MARK_STATUS_RESULTS)*nMaxCount,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_OBJECT_FAVORITES_LIBRARY_MARK_STATUS_RESULTS}
    */
