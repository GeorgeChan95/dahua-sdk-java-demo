...
public class NET_IMAGE_INFO_EX3 extends NetSDKLib.SdkStructure {
	/**
	 * 图片类型 {@link com.csg.demo.dahua.lib.enumeration.EM_IMAGE_TYPE_EX2}
	 */
    public int              emType;
	/**
	 * 在二进制数据块中的偏移
    ...
    */
    public int              nHeight;
	/**
	 * 上传到第三方服务器（例如云上存储）的文件路径
	 */
    public byte[]           szUploadFilePath = new byte[260];
    /**
     * 用于字节对齐
    */
    public byte[]           byReserverd2 = new byte[500];
