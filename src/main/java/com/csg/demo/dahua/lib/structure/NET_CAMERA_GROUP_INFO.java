...
public class NET_CAMERA_GROUP_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 视频源信息数组,用户分配内存,大小为sizeof(NET_CAMERA_INFO)*nCameraCount,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_CAMERA_INFO}
    */
    public Pointer          pCameras;
    /**
     * 远程设备信息, szDeviceID 没有值时有效,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_REMOTE_DEVICE}
    */
