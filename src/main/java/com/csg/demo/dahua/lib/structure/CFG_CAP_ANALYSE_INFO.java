...
public class CFG_CAP_ANALYSE_INFO extends NetSDKLib.SdkStructure {
     ...
     * 支持的检测物体类型
    */
    public BYTE_ARRAY_32[]  szSupportedObjectTypes = new BYTE_ARRAY_32[32];
    /**
     * 支持的检测物体类型数量
    */
    public int              nSupportedObjectTypesNum;
    /**
     * 支持的场景组合项扩展个数
    */
    public int              nSupportedCompEx;
    /**
     * 支持的场景组合项列表扩展,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.CFG_SUPPORTED_COMP}
    */
    public CFG_SUPPORTED_COMP[] stuSupportedCompEx = new CFG_SUPPORTED_COMP[8];
    /**
     * 保留字节
    */
