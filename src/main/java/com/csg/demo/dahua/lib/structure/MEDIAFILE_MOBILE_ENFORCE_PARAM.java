...
import com.csg.demo.dahua.lib.enumeration.EM_MOBILE_ENFORCE_UPLOAD_FLAG;
...
public class MEDIAFILE_MOBILE_ENFORCE_PARAM extends NetSDKLib.SdkStructure {
    ...
    */
    ...
    /**
     * 采集开始时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    public NetSDKLib.NET_TIME stuCollectStartTime = new NetSDKLib.NET_TIME();
    /**
     * 采集结束时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    ...
    */
    ...
    /**
     * UTC开始时间(标准UTC时间), 与stuEndTimeRealUTC配对使用，与(stuBeginTime, stuEndTime)互斥,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    ...
    */
    ...
    /**
     * 采集UTC开始时间(标准UTC时间), 文件的采集时间是一个时间点；如果stuCollectStartTimeRealUTC和stuCollectEndTimeRealUTC同时存在时，则按采集时间段查询,stuStartTimeRealUTC和stuEndTimeRealUTC无效,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    public NetSDKLib.NET_TIME stuCollectStartTimeRealUTC = new NetSDKLib.NET_TIME();
    /**
     * 采集UTC结束时间(标准UTC时间), 文件的采集时间是一个时间点；如果stuCollectStartTimeRealUTC和stuCollectEndTimeRealUTC同时存在时，则按采集时间段查询,stuStartTimeRealUTC和stuEndTimeRealUTC无效,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME}
    */
    ...
    */
    ...
    /**
     * 查询信息里面是否附加GPS点位信息，0：不附加，1：附加
    */
    public int              nWithPosition;
    /**
     * 是否携带nWithPosition字段
    */
    public int              bIsWithPosition;
    /**
     * 是否需要加密
    */
    public int              bNeedEncrypt;
