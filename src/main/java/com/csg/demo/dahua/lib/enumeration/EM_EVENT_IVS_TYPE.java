...
import com.csg.demo.dahua.lib.structure.DEV_EVENT_NUMBERSTAT_INFO;
 ...
 * 对应接口{@link com.csg.demo.dahua.lib.NetSDKLib#CLIENT_RealLoadPictureEx(NetSDKLib.LLong, int, int, int, Callback, Pointer, Pointer)}
 * @date 2020/10/14
 */
public enum EM_EVENT_IVS_TYPE {
    ...
    /**
     * {@link com.csg.demo.dahua.lib.structure.DEV_EVENT_TRAFFIC_PEDESTRAINRUNREDLIGHT_INFO}
     */
     ...
     * {@link com.csg.demo.dahua.lib.structure.DEV_EVENT_SHOP_SIGN_ABNORMAL_INFO}
     */
    ...
    EVENT_IVS_VEHICLE_STATE(0x00000422, "车辆状态事件(对应 NET_DEV_EVENT_VEHICLE_STATE_INFO)"),//车辆状态事件(对应 NET_DEV_EVENT_VEHICLE_STATE_INFO)
    EVENT_IVS_TICKET_EVADE_DETECTION(0x00000316, "逃票检测事件 (对应 DEV_EVENT_TICKET_EVADE_DETECTION_INFO )"),//逃票检测事件 (对应 DEV_EVENT_TICKET_EVADE_DETECTION_INFO )
    EVENT_IVS_LEAKAGE_DETECTION(0x0000038E, "渗漏检测事件(对应 DEV_EVENT_LEAKAGE_DETECTION_INFO)"),//渗漏检测事件(对应 DEV_EVENT_LEAKAGE_DETECTION_INFO)
    EVENT_IVS_STEREO_PRAM_DETECTION(0x00000313, "立体行为婴儿车检测事件 (只用于规则配置)"),//立体行为婴儿车检测事件 (只用于规则配置)
    EVENT_IVS_STEREO_BIG_BAGGAGE_DETECTION(0x00000315, "立体行为大件行李箱检测事件 (只用于规则配置)"),//立体行为大件行李箱检测事件 (只用于规则配置)
    EVENT_IVS_PRAM_DETECTION(0x00000312, "婴儿车检测事件 (对应 DEV_EVENT_PRAM_DETECTION_INFO )"),//婴儿车检测事件 (对应 DEV_EVENT_PRAM_DETECTION_INFO )
    EVENT_IVS_BIG_BAGGAGE_DETECTION(0x00000314, "大件行李箱检测事件 (对应 DEV_EVENT_BIG_BAGGAGE_DETECTION_INFO )"),//大件行李箱检测事件 (对应 DEV_EVENT_BIG_BAGGAGE_DETECTION_INFO )
    EVENT_IVS_PERSONNEL_CATEGORY_COUNT(0x000004BE, "人员类型统计事件(对应结构体 NET_DEV_EVENT_PERSONNEL_CATEGORY_COUNT_INFO )"),//人员类型统计事件(对应结构体 NET_DEV_EVENT_PERSONNEL_CATEGORY_COUNT_INFO )
    EVENT_IVS_SMART_MOTION_EQUIPMENT(0x000004BF, "智能动检事件(对应结构体 NET_DEV_EVENT_SMART_MOTION_EQUIPMENT_INFO)"),//智能动检事件(对应结构体 NET_DEV_EVENT_SMART_MOTION_EQUIPMENT_INFO)
    EVENT_IVS_WASTE_MIXED_INVEST(0x00000425, "垃圾混投事件(对应 NET_DEV_EVENT_WASTE_MIXED_INVEST_INFO)"),//垃圾混投事件(对应 NET_DEV_EVENT_WASTE_MIXED_INVEST_INFO)
    EVENT_IVS_PERSON_CARRY_TRASHBAG(0x00000427, "人员拎袋报警事件(对应 NET_DEV_EVENT_PERSON_CARRY_TRASHBAG_INFO)"),//人员拎袋报警事件(对应 NET_DEV_EVENT_PERSON_CARRY_TRASHBAG_INFO)
    EVENT_IVS_UNBROKEN_TRASHBAG(0x00000426, "垃圾袋未破袋检测事件(对应 NET_DEV_EVENT_UNBROKEN_TRASHBAG_INFO)"),//垃圾袋未破袋检测事件(对应 NET_DEV_EVENT_UNBROKEN_TRASHBAG_INFO)
    EVENT_IVS_DUSTBIN_DETECTION(0x00000397, "垃圾桶检测事件(对应 DEV_EVENT_DUSTBIN_DETECTION_INFO)"),//垃圾桶检测事件(对应 DEV_EVENT_DUSTBIN_DETECTION_INFO)
    EVENT_IVS_NATURAL_DISASTER_DETECTION(0x000004AE, "自然灾害检测(对应 NET_DEV_EVENT_NATURAL_DISASTER_DETECTION_INFO)"),//自然灾害检测(对应 NET_DEV_EVENT_NATURAL_DISASTER_DETECTION_INFO)
    EVENT_IVS_HIGHWAY_DISASTER_DETECTION(0x000004CC, "公路灾害检测(对应结构体 NET_DEV_HIGHWAY_DISASTER_DETECTION_INFO)"),//公路灾害检测(对应结构体 NET_DEV_HIGHWAY_DISASTER_DETECTION_INFO)
    EVENT_IVS_ROAD_CONDITIONS_DETECTION(0x0000039A, "路面检测事件(对应DEV_EVENT_ROAD_CONDITIONS_DETECTION_INFO)"),//路面检测事件(对应DEV_EVENT_ROAD_CONDITIONS_DETECTION_INFO)
    EVENT_IVS_TRAFFIC_DRIVER_NO_BELT(0x00000400, "未系安全带报警事件(对应DEV_EVENT_TRAFFIC_DRIVER_NO_BELT_INFO)"),//未系安全带报警事件(对应DEV_EVENT_TRAFFIC_DRIVER_NO_BELT_INFO)
    EVENT_IVS_ROAD_DAMAGE(0x0000040E, "道路损坏报警事件(对应 DEV_EVENT_ROAD_DAMAGE_ALARM_INFO)"),//道路损坏报警事件(对应 DEV_EVENT_ROAD_DAMAGE_ALARM_INFO)
    EVENT_IVS_TRAFFIC_FACILITIES_ABNORMAL(0x000004C8, "交安设施异常检测事件(对应结构体 NET_DEV_EVENT_TRAFFIC_FACILITIES_ABNORMAL_INFO)"),//交安设施异常检测事件(对应结构体 NET_DEV_EVENT_TRAFFIC_FACILITIES_ABNORMAL_INFO)
    EVENT_IVS_ROAD_SURFACE_COLLAPSE(0x000004CA, "路面塌陷事件(对应结构体 NET_DEV_ROAD_SURFACE_COLLAPSE_INFO)"),//路面塌陷事件(对应结构体 NET_DEV_ROAD_SURFACE_COLLAPSE_INFO)
    EVENT_IVS_CHANNEL_ABNORMAL(0x000004CF, "IVS设备前端通道状态异常事件(对应结构体 NET_DEV_EVENT_IVS_CHANNEL_ABNORMAL_INFO)"),//IVS设备前端通道状态异常事件(对应结构体 NET_DEV_EVENT_IVS_CHANNEL_ABNORMAL_INFO)
    EVENT_IVS_QUANTIFY_MUTATION(0x000004D1, "量化指标异常突变报警事件(对应结构体 NET_DEV_EVENT_QUANTIFY_MUTATION_INFO)"),//量化指标异常突变报警事件(对应结构体 NET_DEV_EVENT_QUANTIFY_MUTATION_INFO)
    EVENT_IVS_QUANTIFY_TREND(0x000004D2, "量化指标异常趋势报警事件(对应结构体 NET_DEV_EVENT_QUANTIFY_TREND_INFO)"),//量化指标异常趋势报警事件(对应结构体 NET_DEV_EVENT_QUANTIFY_TREND_INFO)
    EVENT_IVS_OBJECTCHANGE_DETECTION(0x00000490, "变化事件目标变化检测(对应 NET_DEV_EVENT_OBJECTCHANGE_DETECTION_INFO)"),//变化事件目标变化检测(对应 NET_DEV_EVENT_OBJECTCHANGE_DETECTION_INFO)
    EVENT_IVS_VEHICLE_POSTURE_DETECTION(0x000004D4, "车辆姿态检测事件(对应结构体 NET_DEV_EVENT_VEHICLE_POSTURE_DETECTION_INFO)"),//车辆姿态检测事件(对应结构体 NET_DEV_EVENT_VEHICLE_POSTURE_DETECTION_INFO)
    EVENT_IVS_INTELLITASK_CUSTOM_EVENT(0x000004C9, "智能组合自定义报警事件(对应结构体 NET_INTELLITASK_CUSTOM_EVENT_INFO)"),//智能组合自定义报警事件(对应结构体 NET_INTELLITASK_CUSTOM_EVENT_INFO)
    EVENT_IVS_BURNING_WARNING(0X000004DF, "灼伤报警事件(对应结构体 NET_DEV_EVENT_BURNING_WARNING_INFO)"),//灼伤报警事件(对应结构体 NET_DEV_EVENT_BURNING_WARNING_INFO)
    EVENT_IVS_GAS_TANK_DETECTION(0x0000042D, "煤气罐检测事件(对应 NET_DEV_EVENT_GAS_TANK_DETECTION_INFO)"),//煤气罐检测事件(对应 NET_DEV_EVENT_GAS_TANK_DETECTION_INFO)
    EVENT_IVS_ALARM_METHANE_ALARM(0x00000431, "甲烷报警事件(对应结构体 NET_DEV_EVENT_METHANE_ALARM_INFO)"),//甲烷报警事件(对应结构体 NET_DEV_EVENT_METHANE_ALARM_INFO)
    EVENT_IVS_TRAFFIC_OVER_TAKE_DURING_MEETING(0x000004E5, "会车强行超车事件(对应结构体 NET_DEV_EVENT_TRAFFIC_OVER_TAKE_DURING_MEETING_INFO)"),//会车强行超车事件(对应结构体 NET_DEV_EVENT_TRAFFIC_OVER_TAKE_DURING_MEETING_INFO)
    EVENT_IVS_TRAFFIC_ASSISTANT_WITHOUT_SAFEBELT(0x0000034D, "交通副驾驶未系安全带事件 (对应  DEV_EVENT_TRAFFIC_ASSISTANT_WITHOUT_SAFEBELT )"),//交通副驾驶未系安全带事件 (对应  DEV_EVENT_TRAFFIC_ASSISTANT_WITHOUT_SAFEBELT )
    EVENT_IVS_WATER_LOGGED_DETECTION(0x0000046A, "内涝积水事件(对应 NET_DEV_EVENT_WATER_LOGGED_DETECTION_INFO)"),//内涝积水事件(对应 NET_DEV_EVENT_WATER_LOGGED_DETECTION_INFO)
    EVENT_IVS_SEATING_RATE_DETECTION(0x000004B7, "就座率检测事件(对应结构体 NET_DEV_EVENT_SEATING_RATE_DETECTION_INFO)"),//就座率检测事件(对应结构体 NET_DEV_EVENT_SEATING_RATE_DETECTION_INFO)
    EVENT_IVS_TRAFFIC_NOT_AFTER_HORIZONTAL_PEOPLE(0x00000469, "不礼让行人事件(对应 NET_DEV_EVENT_TRAFFIC_NOT_AFTER_HORIZONTAL_PEOPLE_INFO)"),//不礼让行人事件(对应 NET_DEV_EVENT_TRAFFIC_NOT_AFTER_HORIZONTAL_PEOPLE_INFO)
    EVENT_IVS_TRAFFIC_QUEUE_OVERFLOW(0x0000043C, "排队溢出事件(对应 NET_DEV_EVENT_TRAFFIC_QUEUE_OVERFLOW_INFO)"),//排队溢出事件(对应 NET_DEV_EVENT_TRAFFIC_QUEUE_OVERFLOW_INFO)
    EVENT_IVS_TRAFFIC_QUEUE_TIMEOUT(0x0000043D, "排队超限事件(对应 NET_DEV_EVENT_TRAFFIC_QUEUE_TIMEOUT_INFO)"),//排队超限事件(对应 NET_DEV_EVENT_TRAFFIC_QUEUE_TIMEOUT_INFO)
    EVENT_IVS_FIRE_AWAY_FROM_MAN_DETECTION(0x00000491, "动火离人检测(对应 NET_DEV_EVENT_FIRE_AWAY_FROM_MAN_DETECTION_INFO)"),//动火离人检测(对应 NET_DEV_EVENT_FIRE_AWAY_FROM_MAN_DETECTION_INFO)
    EVENT_IVS_CONVEYER_BELT_COAL_RATIO(0x00000354, "传送带煤量检测(对应DEV_EVENT_CONVEYER_BELT_COAL_RATIO_INFO )"),//传送带煤量检测(对应DEV_EVENT_CONVEYER_BELT_COAL_RATIO_INFO )
    EVENT_IVS_CONVEYOR_NTH_TO_STH_DETECTION(0x00000446, "传送带载体从无到有检测报警事件(对应 NET_DEV_EVENT_CONVEYOR_NTH_TO_STH_DETECTION_INFO)"),//传送带载体从无到有检测报警事件(对应 NET_DEV_EVENT_CONVEYOR_NTH_TO_STH_DETECTION_INFO)
    EVENT_IVS_CONVEYOR_ARTICLE_TYPE(0x00000402, "传送带异物检测事件(对应DEV_EVENT_CONVEYOR_ARTICLE_TYPE_INFO)"),//传送带异物检测事件(对应DEV_EVENT_CONVEYOR_ARTICLE_TYPE_INFO)
    EVENT_IVS_HEAT_IMAGING_TEMPER_INFO(0x000004A0, "热成像测温点温度信息异常报警(对应结构体DEV_EVENT_HEAT_IMAGING_TEMPER_INFO_DETAIL)"),//热成像测温点温度信息异常报警(对应结构体DEV_EVENT_HEAT_IMAGING_TEMPER_INFO_DETAIL)
    EVENT_IVS_CHANGE_DETECTION(0x00000420, "差异检测事件(对应 NET_DEV_EVENT_CHANGE_DETECTION_INFO)"),//差异检测事件(对应 NET_DEV_EVENT_CHANGE_DETECTION_INFO)
    EVENT_IVS_VISION_LANG_MODEL_DETECTION(0x000004BA, "视觉文本模型检测事件(对应结构体 NET_DEV_EVENT_VISION_LANG_MODEL_DETECTION_INFO)"),//视觉文本模型检测事件(对应结构体 NET_DEV_EVENT_VISION_LANG_MODEL_DETECTION_INFO)
    EVENT_IVS_TRAFFIC_CROSSING_SPEEDY(0x00000408, "斑马线不减速事件 (对应 DEV_EVENT_TRAFFIC_CROSSING_SPEEDY_INFO)");//斑马线不减速事件 (对应 DEV_EVENT_TRAFFIC_CROSSING_SPEEDY_INFO)
