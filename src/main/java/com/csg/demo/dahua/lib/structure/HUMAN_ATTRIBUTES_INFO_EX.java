...
public class HUMAN_ATTRIBUTES_INFO_EX extends NetSDKLib.SdkStructure {
    ...
    /**
     * 帽子颜色,参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.EM_CLOTHES_COLOR}
    */
    public int              emCapColor;
    /**
     * 制服类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_UNIFORM_STYLE}
    */
    ...
    */
    ...
    /**
     * 上衣款式,参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.EM_COAT_TYPE}
    */
    public int              emCoatStyle;
    /**
     * 鞋子款式,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_SHOES_TYPE}
    */
    public int              emShoesType;
    /**
     * 鞋子颜色,参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.EM_CLOTHES_COLOR}
    */
    public int              emShoesColor;
    /**
     * 年龄段,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_AGE_SEG}
    */
    public int              emAgeSeg;
    /**
