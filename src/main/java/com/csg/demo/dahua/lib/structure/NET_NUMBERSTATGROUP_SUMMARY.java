...
public class NET_NUMBERSTATGROUP_SUMMARY extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 统计时间秒数，已包含时区偏移,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME_EX}
    */
    ...
    */
    ...
    /**
     * 进入小计,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_NUMBERSTATGROUP_SUBTOTAL}
    */
    public NET_NUMBERSTATGROUP_SUBTOTAL stuEnteredSubtotal = new NET_NUMBERSTATGROUP_SUBTOTAL();
    /**
     * 出去小计,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_NUMBERSTATGROUP_SUBTOTAL}
    */
