...
public class NET_DEV_EVENT_SMART_MOTION_EQUIPMENT_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 设备运行状况检测信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_SMART_MOTION_EQUIPMENT_OBJECT_INFO}
    */
    public NET_SMART_MOTION_EQUIPMENT_OBJECT_INFO[] stuObject = new NET_SMART_MOTION_EQUIPMENT_OBJECT_INFO[64];
    /**
     * 场景大图,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_SMART_MOTION_EQUIPMENT_SCENE_IMAGE_INFO}
    */
