...
/**
 * 事件类型 EVENT_IVS_DUSTBIN_OVER_FLOW(垃圾桶满溢检测事件)对应的规则配置
*/
public class NET_DUSTBIN_OVER_FLOW_RULE_INFO extends NetSDKLib.SdkStructure
{
    /**
     * 结构体大小
    */
    ...
    */
    ...
    /**
     * 算法检测模式选择，两种选一种：0-看的见垃圾桶，1-看不见垃圾桶
    */
    ...
    */
    ...
    public NET_DUSTBIN_OVER_FLOW_RULE_INFO() {
