...
public class NET_IN_CHECK_OBJECT_FAVORITES_LIBRARY_MARK_STATUS extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 记录收藏条件集合, 内存由用户申请释放, 大小为sizeof(NET_OBJECT_FAVORITES_LIBRARY_MARK_STATUS_RESULTS)*nConditionsCount,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_CHECK_MARK_STATUS_CONDITIONS}
    */
