...
public class MEDIAFILE_NONMOTOR_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 非机动车颜色,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_NONMOTOR_COLOR}
    */
    public int              emNonmotorColor;
    /**
     * 非机动车子类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_NONMOTOR_SUBTYPE}
    */
    public int              emNonmotorSubtype;
    /**
     * 头盔状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_HELMET_STATE}
    */
    public int              emHelmetState;
    /**
     * 目标型心(不是包围盒中心), 0-8191相对坐标, 相对于小图,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_POINT}
    */
    ...
    */
    ...
    /**
     * 抠图信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_EVENT_IMAGE_INFO}
    */
