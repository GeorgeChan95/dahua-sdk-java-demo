...
/**
 * 事件类型 EVENT_IVS_FIRE_AWAY_FROM_MAN_DETECTION(动火离人检测)对应的数据块描述信息
*/
public class NET_DEV_EVENT_FIRE_AWAY_FROM_MAN_DETECTION_INFO extends NetSDKLib.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    ...
    /**
     * 物体信息列表,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_MSG_OBJECT}
    */
    ...
    */
    ...
    public NET_DEV_EVENT_FIRE_AWAY_FROM_MAN_DETECTION_INFO() {
    }
}
