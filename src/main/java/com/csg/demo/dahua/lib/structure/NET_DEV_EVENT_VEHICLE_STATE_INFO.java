...
public class NET_DEV_EVENT_VEHICLE_STATE_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 报警标志(保养里程小于2000km时告警标示),参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_VEHICLE_STATE_ALARM_FLAG}
    */
    ...
    */
    public int              nSpeed;
    /**
     * 箱盖状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_COVER_STATUS}
    */
    public int              emCoverStatus;
    /**
     * 举升状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_LIFT_STATUS}
    */
    public int              emLiftStatus;
    /**
     * 载重状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_LOAD_STATUS}
    */
    public int              emLoadStatus;
    /**
     * GPS信息,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_GPS_STATUS_INFO}
    */
