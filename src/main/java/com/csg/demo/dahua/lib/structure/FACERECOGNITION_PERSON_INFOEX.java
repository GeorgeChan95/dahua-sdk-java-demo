...
import com.csg.demo.dahua.lib.enumeration.EM_PERSON_FEATURE_ERRCODE;

import static com.csg.demo.dahua.lib.NetSDKLib.*;
...
public class FACERECOGNITION_PERSON_INFOEX extends NetSDKLib.SdkStructure {
  ...
  /** 人员冻结状态 */
    public int              bFrozenStatus;
    /**
     * 保留字节
    */
    public byte[]           szReserved = new byte[4];
    /**
     * 频次报警信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_PERSON_FREQUENCY_INFO}
    */
    public NET_PERSON_FREQUENCY_INFO stuFrequencyInfo = new NET_PERSON_FREQUENCY_INFO();
    /**
     * 平台唯一标识目标字段，区别于UID,IVSS根据faceRecognitionServer.getCaps能力，SupportIDFromServer值为true时，支持UUID有效
    */
    public byte[]           szUUID = new byte[64];
    /**
     * 路人信息,由用户申请内存, 一次申请一个,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.FACERECOGNITION_CUSTOM_PASSER_BY_INFO}
    */
    public Pointer          pstuCustomPasserbyInfo;
    /**
     * 考生考试信息, 由用户申请内存, 一次申请一个,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.FACERECOGNITION_CUSTOM_EXAMINEE_INFO}
    */
    public Pointer          pstuCustomExamineeInfo;
    /**
     * 住户信息, 由用户申请内存, 一次申请一个,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.FACERECOGNITION_CUSTOM_RESIDENTS_INFO}
    */
    public Pointer          pstuCustomResidentsInfo;
    /**
     * 对应抓拍的唯一id
    */
    public byte[]           szRecordID = new byte[64];
    /**
     * 人员信息扩展2, 由用户申请内存, 一次申请一个,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.FACERECOGNITION_PERSON_INFOEX2}
    */
    public Pointer          pstuPersonInfoEx2;
    /**
     * 人员特征信息使能
    */
    ...
    */
     ...
     * pszFeatureValue的长度
    */
    public int              nFeatureValueLen;
  /** 保留字节 */
    public byte[]           byReserved = new byte[116-NetSDKLib.POINTERSIZE*5];
}
