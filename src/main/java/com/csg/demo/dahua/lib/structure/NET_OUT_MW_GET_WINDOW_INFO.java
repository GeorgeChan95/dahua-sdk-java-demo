...
public class NET_OUT_MW_GET_WINDOW_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 解码通道信息列表,用户申请空间,用户申请列表个数和nVideoInfoNum一致,申请内存大小为sizeof(NET_MW_GET_WINDOW_INFO)*nVideoInfoNum,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_MW_GET_WINDOW_INFO}
    */
