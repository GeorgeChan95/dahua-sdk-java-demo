...
public class DEV_EVENT_PARKINGSPACE_STATUS_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              nMark;
    /**
     * 车位的状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_PARKINGSPACE_STATUS}
    */
    ...
    */
    ...
    /**
     * 车门状态,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_CAR_DOOR_STATE}
    */
    ...
    */
    ...
    /**
     * 车厢状态检测区域, 使用相对坐标体系，取值均为0-8191,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_POINT}
    */
    ...
    */
    ...
    /**
     * 人员闯入报警标志,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_PERSON_INTRUDE_STATUS}
    */
