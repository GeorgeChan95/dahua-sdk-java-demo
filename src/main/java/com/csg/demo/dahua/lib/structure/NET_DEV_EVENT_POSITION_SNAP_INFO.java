...
*/
    ...
    /**
     * 预置点GPS信息,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_GPS_INFO}
    */
    public NetSDKLib.NET_GPS_INFO stuPresetGPS = new NetSDKLib.NET_GPS_INFO();
    /**
     * 营运里程
    */
    public byte[]           szOperationMileage = new byte[64];
    /**
     * 客户端自定义数据
    */
    public byte[]           szUserData = new byte[256];
/** 
预留字节
*/
    public			byte[]         szReserved = new byte[664];
