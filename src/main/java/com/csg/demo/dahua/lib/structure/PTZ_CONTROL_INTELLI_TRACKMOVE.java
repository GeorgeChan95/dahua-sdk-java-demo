...
public class PTZ_CONTROL_INTELLI_TRACKMOVE extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              nFlag;
    /**
     * 云台绝对移动位置,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.PTZ_LOCATION_SPACE_UNIT}
    */
    public PTZ_LOCATION_SPACE_UNIT stuPosition = new PTZ_LOCATION_SPACE_UNIT();
    /**
     * 云台运行速度,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.PTZ_LOCATION_SPEED_UNIT}
    */
    ...
    */
    ...
    /**
     * 跟踪物体信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.PTZ_LOCATION_TRACK_OBJECT}
    */
