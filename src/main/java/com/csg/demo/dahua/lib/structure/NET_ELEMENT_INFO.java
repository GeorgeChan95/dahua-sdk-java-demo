...
{
    /**
     * 播放事件类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_VOICE_BROADCAST_EVENT_TYPE}
    */
    public int              emEventType;
    /**
     * 播放的内容类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_VOICE_BROADCAST_TYPE}
    */
    public int              emType;
    /**
     * 使能播报元素
    ...
    */
    ...
    /**
     * 语音播放内容数组,	本字段优先级高于Type和Content,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_VOICE_BROADCAST_INFO}
    */
