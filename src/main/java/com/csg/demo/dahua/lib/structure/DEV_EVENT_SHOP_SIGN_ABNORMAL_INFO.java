...
import static com.csg.demo.dahua.lib.constant.SDKStructureFieldLenth.DH_MAX_DETECT_REGION_NUM;
import static com.csg.demo.dahua.lib.constant.SDKStructureFieldLenth.HDBJ_MAX_OBJECTS_NUM;

/**
 * @author 47081
 * @version 1.0
 * @description 事件类型
 * {@link com.csg.demo.dahua.lib.enumeration.EM_EVENT_IVS_TYPE#EVENT_IVS_SHOP_SIGN_ABNORMAL}(店招异常事件)对应的数据块描述信息
 * @date 2020/11/17
 */
public class DEV_EVENT_SHOP_SIGN_ABNORMAL_INFO extends NetSDKLib.SdkStructure {
    ...
    /**
     * 智能事件所属大类,对应枚举
     * {@link com.csg.demo.dahua.lib.NetSDKLib.EM_CLASS_TYPE}
     */
