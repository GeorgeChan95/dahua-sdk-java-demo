...
/** 
配置等级 {@link com.csg.demo.dahua.lib.enumeration.EM_XRAY_OBJECT_DETECT_CONFIG_LEVEL}
*/
    public			int            emLevel;
/** 
默认参考等级，该等级的默认配置与参考等级的默认配置一样 {@link com.csg.demo.dahua.lib.enumeration.EM_XRAY_OBJECT_DETECT_CONFIG_LEVEL}
*/
