...
public class NET_WATER_SPEED_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 流速向量的像素坐标起始点，归一化到 1024,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_POINT_EX}
    */
    public NET_POINT_EX     stuStartPoint = new NET_POINT_EX();
    /**
     * 流速向量的像素坐标终点，归一化到 1024,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_POINT_EX}
    */
    public NET_POINT_EX     stuEndPoint = new NET_POINT_EX();
    /**
     * 测速点的物理坐标，单位m,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_3DFLOAT_POINT}
    */
