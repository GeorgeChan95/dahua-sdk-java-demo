...
public class NET_CFG_SMART_MOTION_DETECT extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              bEnable;
    /**
     * 动检敏感级别,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_SMART_MOTION_DETECT_SENSITIVITY_LEVEL}
    */
    public int              emMotionDetectSensitivityLevel;
    /**
     * 智能动态检测对象,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_SMART_MOTION_DETECT_OBJECT}
    */
    ...
    */
    ...
    /**
     * 智能动检检测区域信息,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_SMART_MOTION_DETECT_REGION}
    */
