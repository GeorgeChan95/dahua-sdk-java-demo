...
{
    /**
     * 视频遮挡状态灯色,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_PARKINGSPACELIGHT_INFO}
    */
    public NetSDKLib.NET_PARKINGSPACELIGHT_INFO stuVideoBlind = new NetSDKLib.NET_PARKINGSPACELIGHT_INFO();
    /**
     * 烟雾火焰状态灯色,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_PARKINGSPACELIGHT_INFO}
    */
