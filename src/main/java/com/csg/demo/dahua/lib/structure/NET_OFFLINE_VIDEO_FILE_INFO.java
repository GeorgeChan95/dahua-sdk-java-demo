...
public class NET_OFFLINE_VIDEO_FILE_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    public int              dwSize;
    /**
     * 智能任务启动规则,参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.EM_ANALYSE_TASK_START_RULE}
    */
    public int              emStartRule;
    /**
     * 分析规则信息,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_ANALYSE_RULE}
    */
    public NetSDKLib.NET_ANALYSE_RULE stuRuleInfo = new NetSDKLib.NET_ANALYSE_RULE();
    /**
     * 远程文件访问协议类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_REMOTE_FILE_PROTOCOL_TYPE}
    */
    ...
    */
    ...
    /**
     * 分析文件的加密密钥对列表,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_ANALYSE_TASK_VIDEO_KEY_ENCRYPTION_KEYS}
    */
    ...
    */
    ...
    /**
     * 任务是否持久化（持久化的未删除任务在开机后自动创建）
    */
    public int              bIsTaskPersistent;
