...
public class NET_MEDIA_QUERY_TRAFFICCAR_PARAM_EX extends NetSDKLib.SdkStructure {
    ...
    */
    ...
    /**
     * 是否使用szViolationCode字段
    */
    public int              bUseViolationCode;
    /**
     * 是否使用szCountry字段
    */
    public int              bUseCountry;
    /**
     * 是否使用szPlateCode字段
    */
    public int              bUsePlateCode;
    /**
     * 是否不下发RandomAccess字段
    */
    public int              bUnEnableSupportRandomAccess;
    /**
     * 是否不下发Channel字段
    */
    public int              bUnEnableSupportChannel;
    /**
     * 查询结果排序方式(DB),参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.EM_RESULT_ORDER_TYPE}
    */
    public int              emOrder;
    /**
     * 查询结果排序方式,参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.EM_RESULT_ORDER_TYPE}
    */
    public int              emUniversalOrder;
    /**
     * 保留字节
     */
    public byte[]           byReserved = new byte[924];
