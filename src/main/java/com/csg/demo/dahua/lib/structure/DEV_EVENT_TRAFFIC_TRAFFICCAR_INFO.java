...
public class DEV_EVENT_TRAFFIC_TRAFFICCAR_INFO extends NetSDKLib.SdkStructure {
    ...
    /**
     * 车辆行驶方向 {@link com.csg.demo.dahua.lib.enumeration.EM_TRAFFICCAR_MOVE_DIRECTION}
     */
    ...
    /**
     * 车辆类型 {@link com.csg.demo.dahua.lib.enumeration.EM_TRAFFICCAR_CAR_TYPE}
     */
    public int              emCarType;
    /**
     * 车道类型 {@link com.csg.demo.dahua.lib.enumeration.EM_TRAFFICCAR_LANE_TYPE}
     */
    ...
    /**
     * 收费公路车辆通行费车型分类 {@link com.csg.demo.dahua.lib.enumeration.EM_TOLLS_VEHICLE_TYPE}
     */
    ...
    /**
     * 车牌属性 {@link com.csg.demo.dahua.lib.enumeration.EM_PLATE_ATTRIBUTE}
     */
    public int              emPlateAttribute;
    /**
     * 交通车辆信息扩展, refer to {@link com.csg.demo.dahua.lib.structure.NET_TRAFFICCAR_INFO_EXTERN}
     */
    ...
    */
    ...
    /**
     * 车辆是否冲出检测区域(0-未知 1-冲出 2-未冲出)
    */
    public int              nOverShoot;
    /**
     * 保留字节,留待扩展
     */
