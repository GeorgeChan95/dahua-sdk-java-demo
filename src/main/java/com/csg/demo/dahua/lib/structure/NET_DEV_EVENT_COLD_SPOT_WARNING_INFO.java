...
public class NET_DEV_EVENT_COLD_SPOT_WARNING_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 冷点位置 归一化到[0,8191]上的坐标点,参见结构体定义 {@link com.csg.demo.dahua.lib.structure.NET_POINT_EX}
    */
    ...
    */
    ...
    /**
     * 当前配置的温度单位,参见枚举定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TEMPERATURE_UNIT}
    */
