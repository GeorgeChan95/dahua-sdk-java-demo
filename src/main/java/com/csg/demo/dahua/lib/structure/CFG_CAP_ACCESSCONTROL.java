...
public class CFG_CAP_ACCESSCONTROL extends NetSDKLib.SdkStructure {
	 ...
	 * {@link com.csg.demo.dahua.lib.enumeration.EM_CUSTOM_PASSWORD_ENCRYPTION_MODE}
	 */
    public int              emCustomPasswordEncryption;
	/**
	 * 是否支持信息功能 {@link com.csg.demo.dahua.lib.enumeration.EM_SUPPORTFINGERPRINT}
	 */
	...
	/**
	 * 是否支持门禁快速导入功能 {@link com.csg.demo.dahua.lib.enumeration.EM_SUPPORT_FAST_IMPORT_TYPE}
	 */
    public int              bSupportFastImport;
	/**
	 * 是否支持门禁快速复核功能{@link com.csg.demo.dahua.lib.enumeration.EM_SUPPORT_FAST_CHECK_TYPE}
	 */
	...
	/**
	 * 支持的梯控制方式类型的集合{@link com.csg.demo.dahua.lib.enumeration.EM_SUPPORT_LIFT_CONTROL_TYPES}
	 */
