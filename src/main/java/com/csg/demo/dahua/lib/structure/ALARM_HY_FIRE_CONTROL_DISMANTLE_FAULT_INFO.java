...
public class ALARM_HY_FIRE_CONTROL_DISMANTLE_FAULT_INFO extends NetSDKLib.SdkStructure
{
    ...
    */
    ...
    /**
     * 设备类型,参见枚举定义 {@link com.csg.demo.dahua.lib.enumeration.EM_HY_FIRE_CONTROL_DEVICE_TYPE}
    */
    public int              emDeviceType;
    /**
     * 设备接收到事件的时间,参见结构体定义 {@link com.csg.demo.dahua.lib.NetSDKLib.NET_TIME_EX}
    */
